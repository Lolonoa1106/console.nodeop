  ...
  [3448],
  {
    ...
    72972: function (e, t, n) {
      ...
      function b(e, t, n, r, o, u) {
        if ("undefined" != typeof window && (u || (0, i.isLocalURL)(t))) {
      ...
      let _ = u.default.forwardRef(function (e, t) {
        ...
        let k = u.default.useContext(f.RouterContext),
          ...
          z = u.default.useRef(W),
          K = u.default.useRef(D);
        N && (r = u.default.Children.only(n));
        ...
        try {
          ...
          if ((0, s.isDynamicRoute)(e.pathname) && e.searchParams && n) {
            let n = (0, r.searchParamsToUrlQuery)(e.searchParams),
              { result: a, params: i } = (0, c.interpolateAs)(
                e.pathname,
                e.pathname,
                n
              );
          ...
          parameterizedRoute: t
            .map((e) => {
              let t = r.INTERCEPTION_ROUTE_MARKERS.find((t) => e.startsWith(t)),
                u = e.match(/\[((?:\[.*\])|.+)\]/);
              if (t && u) {
                let { key: e, optional: r, repeat: l } = a(u[1]);
                return (
                  (n[e] = { pos: i++, repeat: l, optional: r }),
                  "/" + (0, o.escapeStringRegexp)(t) + "([^/]+?)"
                );
              }
              if (!u) return "/" + (0, o.escapeStringRegexp)(e);
              {
                let { key: e, repeat: t, optional: r } = a(u[1]);
                return (
                  (n[e] = { pos: i++, repeat: t, optional: r }),
                  t ? (r ? "(?:/(.+?))?" : "/(.+?)") : "/([^/]+?)"
                );
              }
            })
          ...
          if (o.startsWith("[") && o.endsWith("]")) {
            ...
            if (r) {
              if (a) {
                ...
                u(this.restSlugName, n), (this.restSlugName = n), (o = "[...]");
              }
            } else {
              if (a)
                throw Error(
              ...
              u(this.slugName, n), (this.slugName = n), (o = "[]");
            }
          }

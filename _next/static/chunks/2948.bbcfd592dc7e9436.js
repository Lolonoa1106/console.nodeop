(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2948],
  {
    31549: function (e, t, n) {
      var i = n(82957).Buffer;
      let s = n(60668);
      function r(e) {
      ...
      function d(e, t) {
        ...
        if ("bytes" === e)
          return (
            ...
            t.length % 32 != 0 &&
              (u = i.concat([u, s.zeros(32 - (t.length % 32))])),
            u
          );
      ...
      function c(e) {
        if (!i.isBuffer(e)) {
          if (Array.isArray(e)) e = i.from(e);
            ...
            var t;
            e = l(e)
              ? i.from((t = d(e)).length % 2 ? "0" + t : t, "hex")
              : i.from(e);
    ...
    52948: function (e, t, n) {
      ...
      let h = {
        rpc: {
          parse: (e) => p(r.rpc.parse, e),
          invalidRequest: (e) => p(r.rpc.invalidRequest, e),
          invalidParams: (e) => p(r.rpc.invalidParams, e),
          methodNotFound: (e) => p(r.rpc.methodNotFound, e),
          internal: (e) => p(r.rpc.internal, e),
          server: (e) => {
          ...
          invalidInput: (e) => p(r.rpc.invalidInput, e),
          resourceNotFound: (e) => p(r.rpc.resourceNotFound, e),
          resourceUnavailable: (e) => p(r.rpc.resourceUnavailable, e),
          transactionRejected: (e) => p(r.rpc.transactionRejected, e),
          methodNotSupported: (e) => p(r.rpc.methodNotSupported, e),
          limitExceeded: (e) => p(r.rpc.limitExceeded, e),
        },
        provider: {
          userRejectedRequest: (e) => f(r.provider.userRejectedRequest, e),
          unauthorized: (e) => f(r.provider.unauthorized, e),
          unsupportedMethod: (e) => f(r.provider.unsupportedMethod, e),
          disconnected: (e) => f(r.provider.disconnected, e),
          chainDisconnected: (e) => f(r.provider.chainDisconnected, e),
          unsupportedChain: (e) => f(r.provider.unsupportedChain, e),
          custom: (e) => {
            if (!e || "object" != typeof e || Array.isArray(e))
              throw Error(
      ...
      function O(e) {
        if ("string" == typeof e) {
          let t = R(e).toLowerCase();
          if (T(t) && 40 === t.length) return b(L(t));
        }
      ...
      async function G(e, t) {
        let n = B(e);
        return S(new Uint8Array(await crypto.subtle.exportKey(n, t)));
      }
      async function $(e, t) {
        let n = B(e),
          i = M(t).buffer;
      ...
      let Q = { storageKey: "ownPrivateKey", keyType: "private" },
        ...
        V = { storageKey: "peerPublicKey", keyType: "public" };
      class X {
        constructor() {
        ...
        async loadKeysIfNeeded() {
          null === this.ownPrivateKey &&
            ...
            null === this.peerPublicKey &&
              (this.peerPublicKey = await this.loadKey(V)),
      ...
      class eo {
        constructor(e) {
          ...
          (this.metadata = e.metadata),
            ...
            (this.accounts =
              null !== (t = this.storage.loadObject(ei)) && void 0 !== t
                ? t
                : []),
        ...
        async decryptResponseMessage(e) {
          ...
          if (!s) throw h.provider.unauthorized("Invalid session");
          let r = await Y(i.encrypted, s),
          ...
          return o && this.storage.storeObject(ea, o), r;
        }
        updateChain(e, t) {
          var n;
          let i = null != t ? t : this.storage.loadObject(er),
          ...
          return (
            ...
            (s !== this.chain &&
              ...
              null === (n = this.callback) ||
                void 0 === n ||
                n.call(this, "chainChanged", N(s.id))),
            !0)
          );
        }
      }
      ...
      ((eC = eS || (eS = {}))[(eC.DISCONNECTED = 0)] = "DISCONNECTED"),
        (eC[(eC.CONNECTING = 1)] = "CONNECTING"),
        (eC[(eC.CONNECTED = 2)] = "CONNECTED");
      class ep {
      ...
      class ef {
        ...
        async handleIncomingEvent(e) {
          ...
          null === (t = this.listener) ||
            void 0 === t ||
            t.handleWeb3ResponseMessage(i, s);
        }
      ...
      class ev {
        constructor(e, t, n, i = !1) {
          (this.storage = e),
            (this.id = t),
            (this.secret = n),
            (this.key = (0, e_.ci)((0, em.JQ)(`${t}, ${n} WalletLink`))),
            (this._linked = !!i);
        }
        static create(e) {
        ...
        static load(e) {
          let t = e.getItem(ey),
            n = e.getItem(ew),
            i = e.getItem(eb);
          return t && i ? new ev(e, t, i, "1" === n) : null;
        }
        get linked() {
          return this._linked;
        }
      ...
      function eH(e, t, n) {
        var i,
          ...
          a = {};
        for (r in t)
          "key" == r ? (i = t[r]) : "ref" == r ? (s = t[r]) : (a[r] = t[r]);
        if (
          (arguments.length > 2 &&
            (a.children = arguments.length > 3 ? eM.call(arguments, 2) : n),
      ...
      function eB(e, t, n, i, s) {
        ...
        return null == s && null != ex.vnode && ex.vnode(r), r;
      }
      function eG(e) {
        return e.children;
      }
      ...
      function eJ(e, t) {
        if (null == t) return e.__ ? eJ(e.__, e.__i + 1) : null;
        for (var n; t < e.__k.length; t++)
          if (null != (n = e.__k[t]) && null != n.__e) return n.__e;
        return "function" == typeof e.type ? eJ(e) : null;
      }
      function eY(e) {
        ((!e.__d && (e.__d = !0) && eP.push(e) && !eQ.__r++) ||
          eN !== ex.debounceRendering) &&
          ((eN = ex.debounceRendering) || eD)(eQ);
      }
      function eQ() {
        for (var e, t, n, i, s, r, a = 1; eP.length; )
          eP.length > a && eP.sort(eR),
            (e = eP.shift()),
            (a = eP.length),
            e.__d &&
              ((t = void 0),
      ...
      function eZ(e, t, n, i, s, r, a, o, c, l, d) {
        var u,
          h,
          p,
          f,
        ...
        for (
                ...
                ? ((c = r + h),
                  ((a = e.__k[r] =
                    ...
                    a.constructor == String
                      ...
                      : ez(a)
                      ? eB(eG, { children: a }, null, null, null)
                ...
                null != (o = n[r]) &&
                  ...
                  (function e(t, n, i) {
                    ...
                    if (
                      ...
                      (s = t.ref) &&
                        ((s.current && s.current !== t.__e) || e3(s, null, n)),
                      null != (s = t.__c))
                    ) {
                    ...
                    i || eF(t.__e), (t.__c = t.__ = t.__e = void 0);
                  })(o, o));
            return i;
          })(n, t, _, c, y),
            u = 0;
          ...
          null != (p = n.__k[u]) &&
            ((h = -1 === p.__i ? eU : _[p.__i] || eU),
            (p.__i = u),
            (m = e1(e, p, h, s, r, a, o, c, l, d)),
            (f = p.__e),
            p.ref &&
              h.ref != p.ref &&
              (h.ref && e3(h.ref, null, p), d.push(p.ref, p.__c || f, p)),
            null == g && null != f && (g = f),
            4 & p.__u || h.__k === p.__k
              ? (c = (function e(t, n, i) {
                  var s, r;
        ...
        e: if ("style" == t) {
          ...
          (r = t != (t = t.replace(eL, "$1"))),
            ...
            n
              ? i
                ? (n.t = i.t)
                : ((n.t = eT), e.addEventListener(t, r ? eO : ej, r))
              : e.removeEventListener(t, r ? eO : ej, r);
        else {
      ...
      function e1(e, t, n, i, s, r, a, o, c, l) {
        var d,
          u,
          h,
          p,
        ...
        128 & n.__u && ((c = !!(32 & n.__u)), (r = [(o = t.__e = n.__e)])),
          (d = ex.__b) && d(t);
        e: if ("function" == typeof M)
          try {
            if (
              ((_ = t.props),
              (y = "prototype" in M && M.prototype.render),
              (b = (d = M.contextType) && i[d.__c]),
              ...
              y &&
                ...
                (u.__s == u.state && (u.__s = eK({}, u.__s)),
                eK(u.__s, M.getDerivedStateFromProps(_, u.__s))),
              (p = u.props),
              (f = u.state),
              (u.__v = t),
              h)
              ...
              null != u.componentWillUpdate &&
                u.componentWillUpdate(_, u.__s, w),
                y &&
            ...
            (u.state = u.__s),
              null != u.getChildContext &&
                (i = eK(eK({}, i), u.getChildContext())),
              y &&
                !h &&
                null != u.getSnapshotBeforeUpdate &&
                (g = u.getSnapshotBeforeUpdate(p, f)),
              (C = d),
              null != d &&
                d.type === eG &&
                null == d.key &&
              ...
              (o = eZ(e, ez(C) ? C : [C], t, n, i, s, r, a, o, c, l)),
              (u.base = t.__e),
              (t.__u &= -161),
                ...
                (function (e, t, n, i, s, r, a, o, c) {
                  ...
                  if (null == e) {
                    ...
                    (e = document.createElementNS(s, y, _.is && _)),
                      o && (ex.__m && ex.__m(t, r), (o = !1)),
                      (r = null);
                  }
                  if (null === y)
                    m === _ || (o && e.data === _) || (e.data = _);
                  else {
                    if (
                      ((r = r && eM.call(e.childNodes)),
                      (m = n.props || eU),
                      !o && null != r)
                    )
                    ...
                    o ||
                      ...
                      "progress" == y && null == f
                        ...
                        : void 0 === f ||
                          ...
                          eX(e, l, f, m[l], s),
                      (l = "checked"),
                      void 0 !== g && g !== e[l] && eX(e, l, g, m[l], s));
                  }
                  return e;
                })(n.__e, t, n, i, s, r, a, c, l));
        return (d = ex.diffed) && d(t), 128 & t.__u ? void 0 : o;
      }
      function e2(e, t, n) {
        for (var i = 0; i < n.length; i++) e3(n[i], n[++i], n[++i]);
        ex.__c && ex.__c(t, e),
          e.some(function (t) {
            try {
              (e = t.__h),
        ...
        (e$.prototype.setState = function (e, t) {
          ...
          (n =
            null != this.__s && this.__s !== this.state
              ? this.__s
              : (this.__s = eK({}, this.state))),
            "function" == typeof e && (e = e(eK({}, n), this.props)),
            e && eK(n, e),
            null != e && this.__v && (t && this._sb.push(t), eY(this));
        }),
        (e$.prototype.forceUpdate = function (e) {
          this.__v && ((this.__e = !0), e && this.__h.push(e), eY(this));
        }),
        (e$.prototype.render = eG),
        (eP = []),
        (eD =
      ...
      var e8,
        ...
        tc = tn.__;
      function tl(e, t) {
        tn.__h && tn.__h(e6, e, te || t), (te = 0);
        var n = e6.__H || (e6.__H = { __: [], __h: [] });
      ...
      function td(e, t, n) {
        ...
        if (
          ...
          e6.__f = !0;
          var r = e6.shouldComponentUpdate,
            a = e6.componentWillUpdate;
          (e6.componentWillUpdate = function (e, t, n) {
            if (this.__e) {
              var i = r;
      ...
      function tu() {
        for (var e; (e = tt.shift()); )
          if (e.__P && e.__H)
            try {
              e.__H.__h.forEach(tp), e.__H.__h.forEach(tf), (e.__H.__h = []);
            } catch (t) {
              (e.__H.__h = []), tn.__e(t, e.__v);
            }
      }
      (tn.__b = function (e) {
        (e6 = null), ti && ti(e);
        ...
        (tn.__ = function (e, t) {
          e && t.__k && t.__k.__m && (e.__m = t.__k.__m), tc && tc(e, t);
        }),
        (tn.__r = function (e) {
          ts && ts(e), (e8 = 0);
          var t = (e6 = e.__c).__H;
          t &&
            (e7 === e6
              ...
              : (t.__h.forEach(tp), t.__h.forEach(tf), (t.__h = []), (e8 = 0))),
            (e7 = e6);
        }),
        (tn.diffed = function (e) {
          ...
          t &&
            t.__H &&
            (t.__H.__h.length &&
              ((1 !== tt.push(t) && e9 === tn.requestAnimationFrame) ||
                (
      ...
      function tp(e) {
        var t = e6,
          n = e.__c;
        "function" == typeof n && ((e.__c = void 0), n()), (e6 = t);
      }
      function tf(e) {
        var t = e6;
        (e.__c = e.__()), (e6 = t);
      ...
      let t_ = (e) =>
          eH(
            ...
            eH("div", { class: "-cbwsdk-snackbar" }, e.children)
          ),
        ty = ({ autoExpand: e, message: t, menuItems: n }) => {
          var i, s, r, a, o;
          let [c, l] = ((te = 1), td(tg, !0)),
            [d, u] = ((te = 1), td(tg, null != e && e));
          return (
            (i = () => {
              let e = [
                window.setTimeout(() => {
            ...
            !tn.__s &&
              ...
              ((r.__ = i), (r.u = s), e6.__H.__h.push(r)),
            eH(
              "div",
              {
                class: eE(
      ...
      class tE {
          ...
          (this.chainCallbackParams = { chainId: "", jsonRpcUrl: "" }),
            ...
            (this.accountUpdated = (e) => {
              this.accountsCallback && this.accountsCallback([e]),
                tE.accountRequestCallbackIds.size > 0 &&
                  (Array.from(tE.accountRequestCallbackIds.values()).forEach(
                    (t) => {
                  ...
                  tE.accountRequestCallbackIds.clear());
            }),
        ...
        subscribe() {
          let e = ev.load(this.storage) || ev.create(this.storage),
            ...
            i = this.isMobileWeb ? new tI() : new tb();
        ...
        submitEthereumTransaction(e, t) {
          return this.sendRequest({
            ...
            params: { signedTransaction: x(e, !0), chainId: t },
          });
        }
          ...
          return new Promise((s, r) => {
            (t = this.ui.showConnecting({
              ...
              this.relayEventManager.callbacks.set(n, (e) => {
                if ((null == t || t(), ed(e))) return r(Error(e.errorMessage));
                s(e);
              }),
        ...
        handleWeb3ResponseMessage(e, t) {
          if ("requestEthereumAccounts" === t.method) {
            tE.accountRequestCallbackIds.forEach((e) =>
        ...
        requestEthereumAccounts() {
          ...
          return new Promise((e, t) => {
            this.relayEventManager.callbacks.set(i, (n) => {
              ...
              tE.accountRequestCallbackIds.add(i),
      ...
      tE.accountRequestCallbackIds = new Set();
      var tC = n(82957).Buffer;
      ...
      class tx {
        ...
        get jsonRpcUrl() {
          var e;
          return null !== (e = this._storage.getItem(tM)) && void 0 !== e
            ? e
            : void 0;
        }
        set jsonRpcUrl(e) {
        ...
        async addEthereumChain(e) {
          ...
          let r = this.initializeRelay(),
            ...
            u = await r.addEthereumChain(s.toString(), a, l, o, c, d);
          if (ed(u)) return !1;
          if (
            (null === (n = u.result) || void 0 === n
              ? void 0
              : n.isApproved) === !0
          )
        ...
        _prepareTransactionParams(e) {
          ...
          let n = e.to ? O(e.to) : null,
            ...
            s = e.data ? U(e.data) : tC.alloc(0),
            r = null != e.nonce ? W(e.nonce) : null,
        ...
        getChainId() {
          ...
          return Number.parseInt(
            null !== (e = this._storage.getItem(tS)) && void 0 !== e ? e : "1",
            10
          );
        }
      ...
      async function tD(e, t, n) {
        ...
        let i = new tx({ metadata: t, callback: n });
        e.postMessage({
      ...
      let tR = `Coinbase Wallet SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Coinbase Smart Wallet app.

Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
        { checkCrossOriginOpenerPolicy: tL, getCrossOriginOpenerPolicy: tT } = {
          ...
          checkCrossOriginOpenerPolicy: async () => {
            ...
            try {
              ...
              (i = null != n ? n : "null"),
                "same-origin" === i && console.error(tR);
            } catch (e) {
              console.error(
      ...
      class tq extends tU {
                        ...
                        (a[n.toString()] || ((i = n) >= -32099 && i <= -32e3))
                          ? ((s.code = e.code),
                            e.message && "string" == typeof e.message
                              ? ((s.message = e.message),
                                d(e, "data") && (s.data = e.data))
                              : ((s.message = c(s.code)),
                                (s.data = { originalError: l(e) })))
                          : ((s.code = r.rpc.internal),
                            (s.message = u(e, "message") ? e.message : o),
                            (s.data = { originalError: l(e) })),
                        t && (s.stack = u(e, "stack") ? e.stack : void 0),
                        s
                      );
                    })(
                      (function (e) {
        ...
        initSigner(e) {
          return (function (e) {
            ...
            switch (t) {
              case "scw":
                return new eo({ metadata: n, callback: s, communicator: i });
              case "walletlink":
                return new tx({ metadata: n, callback: s });
            }
          })({
            signerType: e,
            metadata: this.metadata,
      ...
      function tK(e) {
        var t;
        new s("CBWSDK").setItem("VERSION", ee), tL();
        let n = {
          metadata: {

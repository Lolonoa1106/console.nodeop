  ...
  [5501],
  {
    61896: function (e, t, n) {
      ...
      let p = !1,
        ...
        M = () => {
          var e;
          return (null == (e = l.useContext(R)) ? void 0 : e.id) || null;
        },
        b = () => l.useContext(y);
      function k(e) {
        void 0 === e && (e = {});
        let { nodeId: t } = e,
          n = (function (e) {
            let { open: t = !1, onOpenChange: n, elements: r } = e,
              ...
              m = l.useMemo(() => ({ setPositionReference: s }), []),
              d = l.useMemo(
                () => ({
        ...
        let v = (0, f.YF)({
          ...
          y = l.useCallback(
            (e) => {
              ((0, c.kK)(e) || null === e) && ((p.current = e), i(e)),
          ...
          E = l.useMemo(
            () => ({ ...v, ...r, refs: k, elements: x, nodeId: t }),
            [v, k, x, t, r]
          );
        return (
          d(() => {
      ...
      function S(e) {
        ...
        let t = e.map((e) => (null == e ? void 0 : e.reference)),
          ...
          u = l.useCallback((t) => H(t, e, "reference"), t),
          o = l.useCallback((t) => H(t, e, "floating"), n),
          c = l.useCallback((t) => H(t, e, "item"), r);
        return l.useMemo(
          () => ({
            getReferenceProps: u,
            getFloatingProps: o,
      ...
      let w = (e) => ({
        ...
        async fn(t) {
          let {
            ...
            v = n.current[c],
            C = (null == g ? void 0 : g.current) || h,
            R = h.clientTop || C.clientTop,
            y = 0 !== h.clientTop,
            M = 0 !== C.clientTop,
            b = h === C;
          if (!v) return {};
          let k = {
            ...
            x = await (0, s.US)(T(k, C.scrollHeight + R + h.clientTop), d),
            E = await (0, s.US)(k, { ...d, elementContext: "reference" }),
            H = (0, o.Fp)(0, x.top),
            S = k.y + H,
            w = (C.scrollHeight > C.clientHeight ? (e) => e : o.NM)(
              (0, o.Fp)(
                0,
                C.scrollHeight +
                  ((y && b) || M ? 2 * R : 0) -
          ...
          if (((C.style.maxHeight = w + "px"), (C.scrollTop = H), l)) {
            let e =
              C.offsetHeight <
          ...
          return (
            r &&
              (r.current = await (0, s.US)(
                T({ ...k, y: S }, C.offsetHeight + R + h.clientTop),
                d
              )),
            { y: S }
          );
      ...
      function F(e, t) {
        let { open: n, elements: r } = e,
          { enabled: o = !0, overflowRef: c, scrollRef: f, onChange: s } = t,
          a = g(s),
          m = l.useRef(!1),
          d = l.useRef(null),
          p = l.useRef(null);

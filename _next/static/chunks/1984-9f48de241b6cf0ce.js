(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1984],
  {
    47223: function (e, t, i) {
      ...
      if (
        ((e.exports = function (e) {
          return r || (r = new f(null)), r.generate(e);
        }),
        (e.exports.Rand = f),
        (f.prototype.generate = function (e) {
          return this._rand(e);
        }),
    ...
    61984: function (e, t, i) {
      "use strict";
      (t.version = i(58274).i8),
        (t.utils = i(36321)),
        (t.rand = i(47223)),
        (t.curve = i(64358)),
        (t.curves = i(83475)),
      ...
      (e.exports = c),
        ...
        (c.prototype._fixedNafMul = function (e, t) {
          ...
          var i,
            r,
            f = e._getDoubles(),
            n = d(t, 1, this._bitLength),
            c = (1 << (f.step + 1)) - (f.step % 2 == 0 ? 2 : 1);
          c /= 3;
          var h = [];
          for (i = 0; i < n.length; i += f.step) {
            r = 0;
            for (var s = i + f.step - 1; s >= i; s--) r = (r << 1) + n[s];
            h.push(r);
          }
          for (
            ...
            for (i = 0; i < h.length; i++)
              (r = h[i]) === b
                ? (u = u.mixedAdd(f.points[i]))
                : r === -b && (u = u.mixedAdd(f.points[i].neg()));
            o = o.add(u);
          }
          return o.toP();
        }),
        (c.prototype._wnafMul = function (e, t) {
          ...
          for (
            var f = r.points,
              n = d(t, i, this._bitLength),
              c = this.jpoint(null, null, null),
              h = n.length - 1;
            h >= 0;
            h--
          ) {
            for (var s = 0; h >= 0 && 0 === n[h]; h--) s++;
            if ((h >= 0 && s++, (c = c.dblp(s)), h < 0)) break;
            var o = n[h];
            a(0 !== o),
              (c =
                "affine" === e.type
        ...
        (c.prototype._wnafMulAdd = function (e, t, i, r, f) {
          var a,
            c,
            h,
            s = this._wnafT1,
            ...
            b = 0;
          for (a = 0; a < r; a++) {
            var l = (h = t[a])._getNAFPoints(e);
            (s[a] = l.wnd), (o[a] = l.points);
          }
          for (a = r - 1; a >= 1; a -= 2) {
            var p = a - 1,
              m = a;
            if (1 !== s[p] || 1 !== s[m]) {
              (u[p] = d(i[p], s[p], this._bitLength)),
                (u[m] = d(i[m], s[m], this._bitLength)),
            ...
            for (
              ...
              var M = 0 | y[0][c],
                w = 0 | y[1][c];
              (u[p][c] = g[(M + 1) * 3 + (w + 1)]), (u[m][c] = 0), (o[p] = v);
            }
          }
            ...
            for (c = 0; c < r; c++) {
              ...
              0 !== I &&
                (I > 0
                  ? (h = o[c][(I - 1) >> 1])
                  : I < 0 && (h = o[c][(-I - 1) >> 1].neg()),
                (S = "affine" === h.type ? S.mixedAdd(h) : S.add(h)));
            }
          }
          for (a = 0; a < r; a++) o[a] = null;
          return f ? S : S.toP();
        }),
        (c.BasePoint = h),
      ...
      d(c, n),
        ...
        (c.prototype.pointFromX = function (e, t) {
          ...
          var i = e.redSqr(),
            ...
            d = this.one.redSub(this.c2.redMul(this.d).redMul(i)),
            n = r.redMul(d.redInvm()),
            a = n.redSqrt();
          if (0 !== a.redSqr().redSub(n).cmp(this.zero))
        ...
        (c.prototype.pointFromY = function (e, t) {
          ...
          var i = e.redSqr(),
            r = i.redSub(this.c2),
            d = i.redMul(this.d).redMul(this.c2).redSub(this.a),
            n = r.redMul(d.redInvm());
          ...
          if (0 !== a.redSqr().redSub(n).cmp(this.zero))
            throw Error("invalid point");
          return (
            a.fromRed().isOdd() !== t && (a = a.redNeg()), this.point(a, e)
          );
        }),
        (c.prototype.validate = function (e) {
          ...
          var t = e.x.redSqr(),
            ...
            f = this.c2.redMul(this.one.redAdd(this.d.redMul(t).redMul(i)));
          return 0 === r.cmp(f);
        }),
        d(h, n.BasePoint),
        ...
        (h.prototype._extDbl = function () {
          ...
          var r = this.curve._mulA(e),
            ...
            s = f.redMul(a),
            o = n.redMul(d);
          return this.curve.point(c, h, o, s);
        }),
        (h.prototype._projDbl = function () {
          ...
          if (this.curve.twisted) {
            var h = (r = this.curve._mulA(a)).redAdd(c);
            this.zOne
              ? ((e = n.redSub(a).redSub(c).redMul(h.redSub(this.curve.two))),
                (t = h.redMul(r.redSub(c))),
                (i = h.redSqr().redSub(h).redSub(h)))
              : ((f = this.z.redSqr()),
                (d = h.redSub(f).redISub(f)),
                (e = n.redSub(a).redISub(c).redMul(d)),
                (t = h.redMul(r.redSub(c))),
                (i = h.redMul(d)));
          } else
            (r = a.redAdd(c)),
              (f = this.curve._mulC(this.z).redSqr()),
              (d = r.redSub(f).redSub(f)),
              (e = this.curve._mulC(n.redISub(r)).redMul(d)),
              (t = this.curve._mulC(r).redMul(a.redISub(c))),
              (i = r.redMul(d));
        ...
        (h.prototype._extAdd = function (e) {
          var t = this.y.redSub(this.x).redMul(e.y.redSub(e.x)),
            ...
            o = d.redMul(c),
            u = n.redMul(a);
          return this.curve.point(h, s, u, o);
        }),
        (h.prototype._projAdd = function (e) {
          var t,
            ...
            d = this.x.redMul(e.x),
            n = this.y.redMul(e.y),
            a = this.curve.d.redMul(d).redMul(n),
            c = f.redSub(a),
            h = f.redAdd(a),
            s = this.x
              .redAdd(this.y)
              ...
              .redISub(d)
              .redISub(n),
            o = r.redMul(c).redMul(s);
          return (
            this.curve.twisted
              ? ((t = r.redMul(h).redMul(n.redSub(this.curve._mulA(d)))),
                (i = c.redMul(h)))
              : ((t = r.redMul(h).redMul(n.redSub(d))),
                (i = this.curve._mulC(c).redMul(h))),
            this.curve.point(o, t, i)
          );
        }),
      ...
      f(a, d),
        ...
        (c.prototype.dbl = function () {
          var e = this.x.redAdd(this.z).redSqr(),
            ...
            i = e.redSub(t),
            r = e.redMul(t),
            f = i.redMul(t.redAdd(this.curve.a24.redMul(i)));
        ...
        (c.prototype.diffAdd = function (e, t) {
          var i = this.x.redAdd(this.z),
            ...
            f = e.x.redAdd(e.z),
            d = e.x.redSub(e.z).redMul(i),
            n = f.redMul(r),
            a = t.z.redMul(d.redAdd(n).redSqr()),
      ...
      d(c, n),
          ...
          if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) {
            if (e.beta) t = new f(e.beta, 16).toRed(this.red);
              ...
              var t,
                i,
                r,
                d = this._getEndoRoots(this.p);
              t = (t = 0 > d[0].cmp(d[1]) ? d[0] : d[1]).toRed(this.red);
            }
            if (e.lambda) i = new f(e.lambda, 16);
            else {
            ...
            return (
              ...
              { beta: t, lambda: i, basis: r }
            );
          }
        }),
        (c.prototype._getEndoRoots = function (e) {
          var t = e === this.p ? this.red : f.mont(e),
            i = new f(2).toRed(t).redInvm(),
            r = i.redNeg(),
            d = new f(3).toRed(t).redNeg().redSqrt().redMul(i);
        ...
        (c.prototype._getEndoBasis = function (e) {
          for (
            ...
            var y = b.div(u);
            (h = b.sub(y.mul(u))), (s = m.sub(y.mul(l)));
            var M = v.sub(y.mul(p));
            if (!r && 0 > h.cmp(o))
              (t = c.neg()), (i = l), (r = h.neg()), (d = s);
            else if (r && 2 == ++g) break;
            (c = h), (b = u), (u = h), (m = l), (l = s), (v = p), (p = M);
          }
          (n = h.neg()), (a = s);
          var w = r.sqr().add(d.sqr());
          return (
            n.sqr().add(a.sqr()).cmp(w) >= 0 && ((n = t), (a = i)),
            r.negative && ((r = r.neg()), (d = d.neg())),
        ...
        (c.prototype._endoSplit = function (e) {
          var t = this.endo.basis,
            ...
            c = f.mul(i.b),
            h = d.mul(r.b);
          return { k1: e.sub(n).sub(a), k2: c.add(h).neg() };
        }),
        (c.prototype.pointFromX = function (e, t) {
          (e = new f(e, 16)).red || (e = e.toRed(this.red));
          var i = e
          ...
          return ((t && !d) || (!t && d)) && (r = r.redNeg()), this.point(e, r);
        }),
        (c.prototype.validate = function (e) {
          if (e.inf) return !0;
          var t = e.x,
            i = e.y,
            r = this.a.redMul(t),
            f = t.redSqr().redMul(t).redIAdd(r).redIAdd(this.b);
          return 0 === i.redSqr().redISub(f).cmpn(0);
        }),
        (c.prototype._endoWnafMulAdd = function (e, t, i) {
          for (
            var r = this._endoWnafT1, f = this._endoWnafT2, d = 0;
            d < e.length;
            d++
          ) {
            var n = this._endoSplit(t[d]),
              a = e[d],
              c = a._getBeta();
            n.k1.negative && (n.k1.ineg(), (a = a.neg(!0))),
          ...
          for (
            var h = this._wnafMulAdd(1, r, f, 2 * d, i), s = 0;
            s < 2 * d;
            s++
          )
            (r[s] = null), (f[s] = null);
        ...
        (h.fromJSON = function (e, t, i) {
          ...
          return (
            (r.precomputed = {
              ...
              doubles: d.doubles && {
                step: d.doubles.step,
                points: [r].concat(d.doubles.points.map(f)),
              },
              naf: d.naf && {
                wnd: d.naf.wnd,
                points: [r].concat(d.naf.points.map(f)),
              },
            }),
            r
          );
        ...
        (h.prototype.dbl = function () {
          ...
          var t = this.curve.a,
            i = this.x.redSqr(),
            r = e.redInvm(),
            f = i.redAdd(i).redIAdd(i).redIAdd(t).redMul(r),
            d = f.redSqr().redISub(this.x.redAdd(this.x)),
            n = f.redMul(this.x.redSub(d)).redISub(this.y);
        ...
        (h.prototype.mul = function (e) {
          return ((e = new f(e, 16)), this.isInfinity())
            ? this
            : this._hasDoubles(e)
            ? this.curve._fixedNafMul(this, e)
            : this.curve.endo
        ...
        (h.prototype.mulAdd = function (e, t, i) {
          ...
          return this.curve.endo
            ? this.curve._endoWnafMulAdd(r, f)
            : this.curve._wnafMulAdd(1, r, f, 2);
        }),
        (h.prototype.jmulAdd = function (e, t, i) {
          var r = [this, t],
            f = [e, i];
          return this.curve.endo
            ? this.curve._endoWnafMulAdd(r, f, !0)
            : this.curve._wnafMulAdd(1, r, f, 2, !0);
        }),
        (h.prototype.eq = function (e) {
          return (
            this === e ||
        ...
        (s.prototype.add = function (e) {
          ...
          var h = a.redSqr(),
            s = h.redMul(a),
            o = r.redMul(h),
            u = c.redSqr().redIAdd(s).redISub(o).redISub(o),
            b = c.redMul(o.redISub(u)).redISub(d.redMul(s)),
        ...
        (s.prototype.mixedAdd = function (e) {
          ...
          var c = n.redSqr(),
            h = c.redMul(n),
            s = i.redMul(c),
            o = a.redSqr().redIAdd(h).redISub(s).redISub(s),
            u = a.redMul(s.redISub(o)).redISub(f.redMul(h)),
            b = this.z.redMul(n);
        ...
        (s.prototype.dblp = function (e) {
          ...
          for (t = 0; t < e; t++) {
            var s = d.redSqr(),
              o = h.redSqr(),
              u = o.redSqr(),
              b = s.redAdd(s).redIAdd(s).redIAdd(r.redMul(c)),
              l = d.redMul(o),
            ...
            var g = h.redMul(a);
            t + 1 < e && (c = c.redMul(u)), (d = p), (a = g), (h = v);
          }
          return this.curve.jpoint(d, h.redMul(f), a);
        }),
        ...
        (s.prototype._zeroDbl = function () {
          if (this.zOne) {
            var e,
              ...
              f = this.y.redSqr(),
              d = f.redSqr(),
              n = this.x.redAdd(f).redSqr().redISub(r).redISub(d);
            n = n.redIAdd(n);
            var a = r.redAdd(r).redIAdd(r),
              c = a.redSqr().redISub(n).redISub(n),
              h = d.redIAdd(d);
            (h = (h = h.redIAdd(h)).redIAdd(h)),
              (e = c),
              (t = a.redMul(n.redISub(c)).redISub(h)),
              (i = this.y.redAdd(this.y));
          } else {
            var s = this.x.redSqr(),
              o = this.y.redSqr(),
              u = o.redSqr(),
              b = this.x.redAdd(o).redSqr().redISub(s).redISub(u);
            b = b.redIAdd(b);
        ...
        (s.prototype._threeDbl = function () {
          if (this.zOne) {
            ...
            var s = this.z.redSqr(),
              o = this.y.redSqr(),
              u = this.x.redMul(o),
              b = this.x.redSub(s).redMul(this.x.redAdd(s));
        ...
        (s.prototype._dbl = function () {
          var e = this.curve.a,
            ...
            d = t.redSqr(),
            n = i.redSqr(),
            a = d.redAdd(d).redIAdd(d).redIAdd(e.redMul(f)),
            c = t.redAdd(t),
            h = (c = c.redIAdd(c)).redMul(n),
            s = a.redSqr().redISub(h.redAdd(h)),
            o = h.redISub(s),
            u = n.redSqr();
          u = (u = (u = u.redIAdd(u)).redIAdd(u)).redIAdd(u);
          var b = a.redMul(o).redISub(u),
            l = i.redAdd(i).redMul(r);
          return this.curve.jpoint(s, b, l);
        }),
        (s.prototype.trpl = function () {
          ...
          var e = this.x.redSqr(),
            ...
            a = (n = (n = (n = n.redIAdd(n)).redAdd(n).redIAdd(n)).redISub(
              d
            )).redSqr(),
            c = r.redIAdd(r);
          c = (c = (c = c.redIAdd(c)).redIAdd(c)).redIAdd(c);
          var h = f.redIAdd(n).redSqr().redISub(d).redISub(a).redISub(c),
            s = t.redMul(h);
          s = (s = s.redIAdd(s)).redIAdd(s);
          var o = this.x.redMul(a).redISub(s);
          o = (o = o.redIAdd(o)).redIAdd(o);
          var u = this.y.redMul(h.redMul(c.redISub(h)).redISub(n.redMul(a)));
          u = (u = (u = u.redIAdd(u)).redIAdd(u)).redIAdd(u);
          var b = this.z.redAdd(n).redSqr().redISub(i).redISub(a);
          return this.curve.jpoint(o, u, b);
        }),
        ...
        (s.prototype.eq = function (e) {
          ...
          var r = t.redMul(this.z),
            f = i.redMul(e.z);
          return 0 === this.y.redMul(f).redISub(e.y.redMul(r)).cmpn(0);
        }),
    ...
    83475: function (e, t, i) {
      ...
      function a(e) {
        "short" === e.type
          ? (this.curve = new d.short(e))
          : "edwards" === e.type
          ? (this.curve = new d.edwards(e))
          : (this.curve = new d.mont(e)),
          (this.g = this.curve.g),
          (this.n = this.curve.n),
          (this.hash = e.hash),
    ...
    90063: function (e, t, i) {
      ...
      (e.exports = o),
        ...
        (o.prototype.genKeyPair = function (e) {
          ...
          for (
            var t = new f({
              ...
              i = this.n.byteLength(),
              d = this.n.sub(new r(2));
            ;

          ) {
            var n = new r(t.generate(i));
            if (!(n.cmp(d) > 0)) return n.iaddn(1), this.keyFromPrivate(n);
          }
        }),
        (o.prototype._truncateToN = function (e, t, i) {
          if (r.isBN(e) || "number" == typeof e)
            f = (e = new r(e, 16)).byteLength();
          else if ("object" == typeof e) (f = e.length), (e = new r(e, 16));
          else {
            var f,
              d = e.toString();
            (f = (d.length + 1) >>> 1), (e = new r(d, 16));
          }
          "number" != typeof i && (i = 8 * f);
          var n = i - this.n.bitLength();
          return (n > 0 && (e = e.ushrn(n)), !t && e.cmp(this.n) >= 0)
            ? e.sub(this.n)
            : e;
        }),
        (o.prototype.sign = function (e, t, i, d) {
          if (
            ("object" == typeof i && ((d = i), (i = null)),
            d || (d = {}),
            "string" != typeof e && "number" != typeof e && !r.isBN(e))
          ) {
            c(
            ...
            for (var n = 0; n < e.length; n++) c((255 & e[n]) === e[n]);
          }
          (t = this.keyFromPrivate(t, i)),
            c(
              !(e = this._truncateToN(e, !1, d.msgBitLength)).isNeg(),
              "Can not sign a negative message"
            );
          var a = this.n.byteLength(),
            h = t.getPrivate().toArray("be", a),
            o = e.toArray("be", a);
          c(new r(o).eq(e), "Can not sign message");
          for (
            var u = new f({
                hash: this.hash,
                entropy: h,
              ...
              b = this.n.sub(new r(1)),
              l = 0;
            ;
            l++
          ) {
            var p = d.k ? d.k(l) : new r(u.generate(this.n.byteLength()));
            if (
              !(0 >= (p = this._truncateToN(p, !0)).cmpn(1) || p.cmp(b) >= 0)
            ) {
              var m = this.g.mul(p);
              if (!m.isInfinity()) {
                var v = m.getX(),
                ...
                if (0 !== g.cmpn(0)) {
                  ...
                  if (0 !== (y = y.umod(this.n)).cmpn(0)) {
                    var M =
                      (m.getY().isOdd() ? 1 : 0) | (0 !== v.cmp(g) ? 2 : 0);
                    return (
                      d.canonical &&
                        y.cmp(this.nh) > 0 &&
                        ((y = this.n.sub(y)), (M ^= 1)),
                      new s({ r: g, s: y, recoveryParam: M })
                    );
                  }
                }
              }
        ...
        (o.prototype.verify = function (e, t, i, r, f) {
          f || (f = {}),
            (e = this._truncateToN(e, !1, f.msgBitLength)),
          ...
          var c = a.invm(this.n),
            ...
            o = c.mul(n).umod(this.n);
          return this.curve._maxwellTrick
            ? !(d = this.g.jmulAdd(h, i.getPublic(), o)).isInfinity() &&
                d.eqXToP(n)
            : !(d = this.g.mulAdd(h, i.getPublic(), o)).isInfinity() &&
                0 === d.getX().umod(this.n).cmp(n);
        }),
        (o.prototype.recoverPubKey = function (e, t, i, f) {
          ...
          var b = t.r.invm(d),
            l = d.sub(n).mul(b).umod(d),
            p = h.mul(b).umod(d);
          return this.g.mulAdd(l, a, p);
        }),
        (o.prototype.getKeyRecoveryParam = function (e, t, i, r) {
          if (null !== (t = new s(t, r)).recoveryParam) return t.recoveryParam;
          for (var f, d = 0; d < 4; d++) {
            try {
    ...
    61258: function (e, t, i) {
      ...
      (e.exports = d),
        (d.fromPublic = function (e, t, i) {
          return t instanceof d ? t : new d(e, { pub: t, pubEnc: i });
        }),
        (d.fromPrivate = function (e, t, i) {
          return t instanceof d ? t : new d(e, { priv: t, privEnc: i });
        }),
        ...
        (d.prototype._importPublic = function (e, t) {
          if (e.x || e.y) {
            "mont" === this.ec.curve.type
              ? f(e.x, "Need x coordinate")
              : ("short" === this.ec.curve.type ||
                  "edwards" === this.ec.curve.type) &&
                f(e.x && e.y, "Need both x and y coordinate"),
        ...
        (d.prototype.derive = function (e) {
          return (
            e.validate() || f(e.validate(), "public point not validated"),
    ...
    90362: function (e, t, i) {
      ...
      function c(e, t) {
        ...
        for (var f = 0, d = 0, n = t.place; d < r; d++, n++)
          (f <<= 8), (f |= e[n]), (f >>>= 0);
      ...
      (e.exports = n),
        (n.prototype._importDER = function (e, t) {
          ...
          var d = c(e, i);
          if (!1 === d || d + i.place !== e.length || 2 !== e[i.place++])
            return !1;
          var n = c(e, i);
          if (!1 === n || (128 & e[i.place]) != 0) return !1;
          var h = e.slice(i.place, n + i.place);
          if (((i.place += n), 2 !== e[i.place++])) return !1;
          var s = c(e, i);
          if (!1 === s || e.length !== s + i.place || (128 & e[i.place]) != 0)
            return !1;
        ...
        (n.prototype.toDER = function (e) {
          ...
          for (
            ...
            i = i.slice(1);
          var r = [2];
          s(r, t.length), (r = r.concat(t)).push(2), s(r, i.length);
          var d = r.concat(i),
            n = [48];
          return s(n, d.length), (n = n.concat(d)), f.encode(n, e);
        });
    },
    37115: function (e, t, i) {
      "use strict";
      var r = i(28714),
        f = i(83475),
        d = i(36321),
      ...
      (e.exports = s),
        (s.prototype.sign = function (e, t) {
          ...
          var i = this.keyFromSecret(t),
            ...
            f = this.g.mul(r),
            d = this.encodePoint(f),
            n = this.hashInt(d, i.pubBytes(), e).mul(i.priv()),
            c = r.add(n).umod(this.curve.n);
          return this.makeSignature({ R: f, S: c, Rencoded: d });
        }),
        (s.prototype.verify = function (e, t, i) {
          if (
            ((e = a(e)),
          ...
          var r = this.keyFromPublic(i),
            f = this.hashInt(t.Rencoded(), r.pubBytes(), e),
            d = this.g.mul(t.S());
          return t.R().add(r.pub().mul(f)).eq(d);
        }),
        ...
        (s.prototype.decodePoint = function (e) {
          var t = (e = d.parseBytes(e)).length - 1,
            ...
            r = (128 & e[t]) != 0,
            f = d.intFromLE(i);
          return this.curve.pointFromY(f, r);
        }),
    ...
    76244: function (e, t, i) {
      ...
      (a.fromPublic = function (e, t) {
        ...
        (a.prototype.sign = function (e) {
          return (
            f(this._secret, "KeyPair can only verify"), this.eddsa.sign(e, this)
          );
        }),
    ...
    55967: function (e, t, i) {
      ...
      function c(e, t) {
        (this.eddsa = e),
          ...
          Array.isArray(t) &&
            (d(t.length === 2 * e.encodingLength, "Signature has invalid size"),
            (t = {
              R: t.slice(0, e.encodingLength),
    ...
    36321: function (e, t, i) {
      ...
      (t.assert = f),
        ...
        (t.getJSF = function (e, t) {
          var i = [[], []];
          (e = e.clone()), (t = t.clone());
          for (var r = 0, f = 0; e.cmpn(-r) > 0 || t.cmpn(-f) > 0; ) {
            var d,
              n,
              a,
              c = (e.andln(3) + r) & 3,
    ...
    21803: function (e, t, i) {
      !(function (e, t) {
        ...
        (d.isBN = function (e) {
          ...
          (d.prototype._init = function (e, t, i) {
            ...
            "-" === (e = e.toString().replace(/\s+/g, ""))[0] &&
              ...
              f < e.length &&
                (16 === t
                  ? this._parseHex(e, f, i)
                  : (this._parseBase(e, t, f),
                    "le" === i && this._initArray(this.toArray(), t, i)));
          }),
          (d.prototype._initNumber = function (e, t, i) {
          ...
          (d.prototype._initArray = function (e, t, i) {
            if ((r("number" == typeof e.length), e.length <= 0))
              return (this.words = [0]), (this.length = 1), this;
            (this.length = Math.ceil(e.length / 3)),
              (this.words = Array(this.length));
            for (var f, d, n = 0; n < this.length; n++) this.words[n] = 0;
            var a = 0;
            if ("be" === i)
              for (n = e.length - 1, f = 0; n >= 0; n -= 3)
                (d = e[n] | (e[n - 1] << 8) | (e[n - 2] << 16)),
                  (this.words[f] |= (d << a) & 67108863),
                  (this.words[f + 1] = (d >>> (26 - a)) & 67108863),
                  (a += 24) >= 26 && ((a -= 26), f++);
            else if ("le" === i)
          ...
          (d.prototype._parseHex = function (e, t, i) {
            (this.length = Math.ceil((e.length - t) / 6)),
              (this.words = Array(this.length));
            for (var r, f = 0; f < this.length; f++) this.words[f] = 0;
            var d = 0,
              n = 0;
            if ("be" === i)
              for (f = e.length - 1; f >= t; f -= 2)
                (r = a(e, t, f) << d),
                  (this.words[n] |= 67108863 & r),
                  d >= 18
                    ? ((d -= 18), (n += 1), (this.words[n] |= r >>> 26))
                    : (d += 8);
            else
              for (
                f = (e.length - t) % 2 == 0 ? t + 1 : t;
                f < e.length;
                f += 2
              )
                (r = a(e, t, f) << d),
          ...
          (d.prototype._parseBase = function (e, t, i) {
            (this.words = [0]), (this.length = 1);
            for (var r = 0, f = 1; f <= 67108863; f *= t) r++;
            r--, (f = (f / t) | 0);
            for (
              var d = e.length - i,
                n = d % r,
            ...
            if (0 !== n) {
              var o = 1;
              for (h = c(e, s, e.length, t), s = 0; s < n; s++) o *= t;
              this.imuln(o),
                this.words[0] + h < 67108864
                  ? (this.words[0] += h)
                  : this._iaddn(h);
        ...
        function b(e, t, i) {
          ...
          for (var h = 1; h < r; h++) {
            for (
              var s = c >>> 26,
                o = 67108863 & c,
                u = Math.min(h, t.length - 1),
                b = Math.max(0, h - e.length + 1);
              b <= u;
              b++
            ) {
              var l = (h - b) | 0;
              (s +=
                ((n = (f = 0 | e.words[l]) * (d = 0 | t.words[b]) + o) /
                  67108864) |
                0),
                (o = 67108863 & n);
            }
        ...
        (d.prototype.toString = function (e, t) {
          if (((t = 0 | t || 1), 16 === (e = e || 10) || "hex" === e)) {
            i = "";
            for (var i, f = 0, d = 0, n = 0; n < this.length; n++) {
              var a = this.words[n],
                c = (((a << f) | d) & 16777215).toString(16);
              (d = (a >>> (24 - f)) & 16777215),
                (f += 2) >= 26 && ((f -= 26), n--),
                (i =
                  0 !== d || n !== this.length - 1
            ...
            for (0 !== d && (i = d.toString(16) + i); i.length % t != 0; )
              i = "0" + i;
          ...
          if (e === (0 | e) && e >= 2 && e <= 36) {
            ...
            for (l.negative = 0; !l.isZero(); ) {
              ...
              i = (l = l.idivn(b)).isZero() ? p + i : s[h - p.length] + p + i;
            }
          ...
          (d.prototype.toBuffer = function (e, t) {
            return r(void 0 !== h), this.toArrayLike(h, e, t);
          }),
          (d.prototype.toArray = function (e, t) {
            return this.toArrayLike(Array, e, t);
          }),
          (d.prototype.toArrayLike = function (e, t, i) {
            var f,
              d,
              n = this.byteLength(),
              a = i || Math.max(1, n);
            ...
            if ("le" === t) {
              for (d = 0; !h.isZero(); d++)
                (f = h.andln(255)), h.iushrn(8), (c[d] = f);
              for (; d < a; d++) c[d] = 0;
            } else {
              for (d = 0; d < a - n; d++) c[d] = 0;
              for (d = 0; !h.isZero(); d++)
                (f = h.andln(255)), h.iushrn(8), (c[a - d - 1] = f);
            }
            return c;
          }),
          Math.clz32
          ...
          (d.prototype.inotn = function (e) {
            ...
            return (
              i > 0 &&
                (this.words[f] = ~this.words[f] & (67108863 >> (26 - i))),
              this.strip()
            );
          }),
          ...
          (d.prototype.iadd = function (e) {
            ...
            this.length > e.length
              ? ((i = this), (r = e))
              : ((i = e), (r = this));
            for (var t, i, r, f = 0, d = 0; d < r.length; d++)
              (t = (0 | i.words[d]) + (0 | r.words[d]) + f),
                (this.words[d] = 67108863 & t),
                (f = t >>> 26);
            for (; 0 !== f && d < i.length; d++)
              (t = (0 | i.words[d]) + f),
                (this.words[d] = 67108863 & t),
                (f = t >>> 26);
            if (((this.length = i.length), 0 !== f))
          ...
          (d.prototype.isub = function (e) {
            ...
            f > 0 ? ((t = this), (i = e)) : ((t = e), (i = this));
            for (var d = 0, n = 0; n < i.length; n++)
              (d = (r = (0 | t.words[n]) - (0 | i.words[n]) + d) >> 26),
                (this.words[n] = 67108863 & r);
            for (; 0 !== d && n < t.length; n++)
              (d = (r = (0 | t.words[n]) + d) >> 26),
                (this.words[n] = 67108863 & r);
            if (0 === d && n < t.length && t !== this)
        ...
        var l = function (e, t, i) {
          ...
          var em =
            (((h + (r = Math.imul(o, Z))) | 0) +
              ((8191 & (f = ((f = Math.imul(o, J)) + Math.imul(u, Z)) | 0)) <<
                13)) |
            0;
          (h = ((((d = Math.imul(u, J)) + (f >>> 13)) | 0) + (em >>> 26)) | 0),
            (em &= 67108863),
            (r = Math.imul(l, Z)),
            (f = ((f = Math.imul(l, J)) + Math.imul(p, Z)) | 0),
            (d = Math.imul(p, J));
          var ev =
            (((h + (r = (r + Math.imul(o, X)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(o, D)) | 0) + Math.imul(u, X)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(u, D)) | 0) + (f >>> 13)) | 0) +
              (ev >>> 26)) |
            0),
            (ev &= 67108863),
            (r = Math.imul(v, Z)),
            (f = ((f = Math.imul(v, J)) + Math.imul(g, Z)) | 0),
            (d = Math.imul(g, J)),
            (r = (r + Math.imul(l, X)) | 0),
            (f = ((f = (f + Math.imul(l, D)) | 0) + Math.imul(p, X)) | 0),
            (d = (d + Math.imul(p, D)) | 0);
          var eg =
            (((h + (r = (r + Math.imul(o, V)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(o, W)) | 0) + Math.imul(u, V)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(u, W)) | 0) + (f >>> 13)) | 0) +
              (eg >>> 26)) |
            0),
            (eg &= 67108863),
            (r = Math.imul(M, Z)),
            (f = ((f = Math.imul(M, J)) + Math.imul(w, Z)) | 0),
            (d = Math.imul(w, J)),
            (r = (r + Math.imul(v, X)) | 0),
            (f = ((f = (f + Math.imul(v, D)) | 0) + Math.imul(g, X)) | 0),
            (d = (d + Math.imul(g, D)) | 0),
            (r = (r + Math.imul(l, V)) | 0),
            (f = ((f = (f + Math.imul(l, W)) | 0) + Math.imul(p, V)) | 0),
            (d = (d + Math.imul(p, W)) | 0);
          var ey =
            (((h + (r = (r + Math.imul(o, U)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(o, G)) | 0) + Math.imul(u, U)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(u, G)) | 0) + (f >>> 13)) | 0) +
              (ey >>> 26)) |
            0),
            (ey &= 67108863),
            (r = Math.imul(_, Z)),
            (f = ((f = Math.imul(_, J)) + Math.imul(A, Z)) | 0),
            (d = Math.imul(A, J)),
            (r = (r + Math.imul(M, X)) | 0),
            (f = ((f = (f + Math.imul(M, D)) | 0) + Math.imul(w, X)) | 0),
            (d = (d + Math.imul(w, D)) | 0),
            (r = (r + Math.imul(v, V)) | 0),
            (f = ((f = (f + Math.imul(v, W)) | 0) + Math.imul(g, V)) | 0),
            (d = (d + Math.imul(g, W)) | 0),
            (r = (r + Math.imul(l, U)) | 0),
            (f = ((f = (f + Math.imul(l, G)) | 0) + Math.imul(p, U)) | 0),
            (d = (d + Math.imul(p, G)) | 0);
          var eM =
            (((h + (r = (r + Math.imul(o, $)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(o, ee)) | 0) + Math.imul(u, $)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(u, ee)) | 0) + (f >>> 13)) | 0) +
              (eM >>> 26)) |
            0),
            (eM &= 67108863),
            (r = Math.imul(I, Z)),
            (f = ((f = Math.imul(I, J)) + Math.imul(z, Z)) | 0),
            (d = Math.imul(z, J)),
            (r = (r + Math.imul(_, X)) | 0),
            (f = ((f = (f + Math.imul(_, D)) | 0) + Math.imul(A, X)) | 0),
            (d = (d + Math.imul(A, D)) | 0),
            (r = (r + Math.imul(M, V)) | 0),
            (f = ((f = (f + Math.imul(M, W)) | 0) + Math.imul(w, V)) | 0),
            (d = (d + Math.imul(w, W)) | 0),
            (r = (r + Math.imul(v, U)) | 0),
            (f = ((f = (f + Math.imul(v, G)) | 0) + Math.imul(g, U)) | 0),
            (d = (d + Math.imul(g, G)) | 0),
            (r = (r + Math.imul(l, $)) | 0),
            (f = ((f = (f + Math.imul(l, ee)) | 0) + Math.imul(p, $)) | 0),
            (d = (d + Math.imul(p, ee)) | 0);
          var ew =
            (((h + (r = (r + Math.imul(o, ei)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(o, er)) | 0) + Math.imul(u, ei)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(u, er)) | 0) + (f >>> 13)) | 0) +
              (ew >>> 26)) |
            0),
            (ew &= 67108863),
            (r = Math.imul(R, Z)),
            (f = ((f = Math.imul(R, J)) + Math.imul(k, Z)) | 0),
            (d = Math.imul(k, J)),
            (r = (r + Math.imul(I, X)) | 0),
            (f = ((f = (f + Math.imul(I, D)) | 0) + Math.imul(z, X)) | 0),
            (d = (d + Math.imul(z, D)) | 0),
            (r = (r + Math.imul(_, V)) | 0),
            (f = ((f = (f + Math.imul(_, W)) | 0) + Math.imul(A, V)) | 0),
            (d = (d + Math.imul(A, W)) | 0),
            (r = (r + Math.imul(M, U)) | 0),
            (f = ((f = (f + Math.imul(M, G)) | 0) + Math.imul(w, U)) | 0),
            (d = (d + Math.imul(w, G)) | 0),
            (r = (r + Math.imul(v, $)) | 0),
            (f = ((f = (f + Math.imul(v, ee)) | 0) + Math.imul(g, $)) | 0),
            (d = (d + Math.imul(g, ee)) | 0),
            (r = (r + Math.imul(l, ei)) | 0),
            (f = ((f = (f + Math.imul(l, er)) | 0) + Math.imul(p, ei)) | 0),
            (d = (d + Math.imul(p, er)) | 0);
          var eS =
            (((h + (r = (r + Math.imul(o, ed)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(o, en)) | 0) + Math.imul(u, ed)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(u, en)) | 0) + (f >>> 13)) | 0) +
              (eS >>> 26)) |
            0),
            (eS &= 67108863),
            (r = Math.imul(N, Z)),
            (f = ((f = Math.imul(N, J)) + Math.imul(B, Z)) | 0),
            (d = Math.imul(B, J)),
            (r = (r + Math.imul(R, X)) | 0),
            (f = ((f = (f + Math.imul(R, D)) | 0) + Math.imul(k, X)) | 0),
            (d = (d + Math.imul(k, D)) | 0),
            (r = (r + Math.imul(I, V)) | 0),
            (f = ((f = (f + Math.imul(I, W)) | 0) + Math.imul(z, V)) | 0),
            (d = (d + Math.imul(z, W)) | 0),
            (r = (r + Math.imul(_, U)) | 0),
            (f = ((f = (f + Math.imul(_, G)) | 0) + Math.imul(A, U)) | 0),
            (d = (d + Math.imul(A, G)) | 0),
            (r = (r + Math.imul(M, $)) | 0),
            (f = ((f = (f + Math.imul(M, ee)) | 0) + Math.imul(w, $)) | 0),
            (d = (d + Math.imul(w, ee)) | 0),
            (r = (r + Math.imul(v, ei)) | 0),
            (f = ((f = (f + Math.imul(v, er)) | 0) + Math.imul(g, ei)) | 0),
            (d = (d + Math.imul(g, er)) | 0),
            (r = (r + Math.imul(l, ed)) | 0),
            (f = ((f = (f + Math.imul(l, en)) | 0) + Math.imul(p, ed)) | 0),
            (d = (d + Math.imul(p, en)) | 0);
          var e_ =
            (((h + (r = (r + Math.imul(o, ec)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(o, eh)) | 0) + Math.imul(u, ec)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(u, eh)) | 0) + (f >>> 13)) | 0) +
              (e_ >>> 26)) |
            0),
            (e_ &= 67108863),
            (r = Math.imul(L, Z)),
            (f = ((f = Math.imul(L, J)) + Math.imul(j, Z)) | 0),
            (d = Math.imul(j, J)),
            (r = (r + Math.imul(N, X)) | 0),
            (f = ((f = (f + Math.imul(N, D)) | 0) + Math.imul(B, X)) | 0),
            (d = (d + Math.imul(B, D)) | 0),
            (r = (r + Math.imul(R, V)) | 0),
            (f = ((f = (f + Math.imul(R, W)) | 0) + Math.imul(k, V)) | 0),
            (d = (d + Math.imul(k, W)) | 0),
            (r = (r + Math.imul(I, U)) | 0),
            (f = ((f = (f + Math.imul(I, G)) | 0) + Math.imul(z, U)) | 0),
            (d = (d + Math.imul(z, G)) | 0),
            (r = (r + Math.imul(_, $)) | 0),
            (f = ((f = (f + Math.imul(_, ee)) | 0) + Math.imul(A, $)) | 0),
            (d = (d + Math.imul(A, ee)) | 0),
            (r = (r + Math.imul(M, ei)) | 0),
            (f = ((f = (f + Math.imul(M, er)) | 0) + Math.imul(w, ei)) | 0),
            (d = (d + Math.imul(w, er)) | 0),
            (r = (r + Math.imul(v, ed)) | 0),
            (f = ((f = (f + Math.imul(v, en)) | 0) + Math.imul(g, ed)) | 0),
            (d = (d + Math.imul(g, en)) | 0),
            (r = (r + Math.imul(l, ec)) | 0),
            (f = ((f = (f + Math.imul(l, eh)) | 0) + Math.imul(p, ec)) | 0),
            (d = (d + Math.imul(p, eh)) | 0);
          var eA =
            (((h + (r = (r + Math.imul(o, eo)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(o, eu)) | 0) + Math.imul(u, eo)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(u, eu)) | 0) + (f >>> 13)) | 0) +
              (eA >>> 26)) |
            0),
            (eA &= 67108863),
            (r = Math.imul(C, Z)),
            (f = ((f = Math.imul(C, J)) + Math.imul(F, Z)) | 0),
            (d = Math.imul(F, J)),
            (r = (r + Math.imul(L, X)) | 0),
            (f = ((f = (f + Math.imul(L, D)) | 0) + Math.imul(j, X)) | 0),
            (d = (d + Math.imul(j, D)) | 0),
            (r = (r + Math.imul(N, V)) | 0),
            (f = ((f = (f + Math.imul(N, W)) | 0) + Math.imul(B, V)) | 0),
            (d = (d + Math.imul(B, W)) | 0),
            (r = (r + Math.imul(R, U)) | 0),
            (f = ((f = (f + Math.imul(R, G)) | 0) + Math.imul(k, U)) | 0),
            (d = (d + Math.imul(k, G)) | 0),
            (r = (r + Math.imul(I, $)) | 0),
            (f = ((f = (f + Math.imul(I, ee)) | 0) + Math.imul(z, $)) | 0),
            (d = (d + Math.imul(z, ee)) | 0),
            (r = (r + Math.imul(_, ei)) | 0),
            (f = ((f = (f + Math.imul(_, er)) | 0) + Math.imul(A, ei)) | 0),
            (d = (d + Math.imul(A, er)) | 0),
            (r = (r + Math.imul(M, ed)) | 0),
            (f = ((f = (f + Math.imul(M, en)) | 0) + Math.imul(w, ed)) | 0),
            (d = (d + Math.imul(w, en)) | 0),
            (r = (r + Math.imul(v, ec)) | 0),
            (f = ((f = (f + Math.imul(v, eh)) | 0) + Math.imul(g, ec)) | 0),
            (d = (d + Math.imul(g, eh)) | 0),
            (r = (r + Math.imul(l, eo)) | 0),
            (f = ((f = (f + Math.imul(l, eu)) | 0) + Math.imul(p, eo)) | 0),
            (d = (d + Math.imul(p, eu)) | 0);
          var ex =
            (((h + (r = (r + Math.imul(o, el)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(o, ep)) | 0) + Math.imul(u, el)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(u, ep)) | 0) + (f >>> 13)) | 0) +
              (ex >>> 26)) |
            0),
            (ex &= 67108863),
            (r = Math.imul(C, X)),
            (f = ((f = Math.imul(C, D)) + Math.imul(F, X)) | 0),
            (d = Math.imul(F, D)),
            (r = (r + Math.imul(L, V)) | 0),
            (f = ((f = (f + Math.imul(L, W)) | 0) + Math.imul(j, V)) | 0),
            (d = (d + Math.imul(j, W)) | 0),
            (r = (r + Math.imul(N, U)) | 0),
            (f = ((f = (f + Math.imul(N, G)) | 0) + Math.imul(B, U)) | 0),
            (d = (d + Math.imul(B, G)) | 0),
            (r = (r + Math.imul(R, $)) | 0),
            (f = ((f = (f + Math.imul(R, ee)) | 0) + Math.imul(k, $)) | 0),
            (d = (d + Math.imul(k, ee)) | 0),
            (r = (r + Math.imul(I, ei)) | 0),
            (f = ((f = (f + Math.imul(I, er)) | 0) + Math.imul(z, ei)) | 0),
            (d = (d + Math.imul(z, er)) | 0),
            (r = (r + Math.imul(_, ed)) | 0),
            (f = ((f = (f + Math.imul(_, en)) | 0) + Math.imul(A, ed)) | 0),
            (d = (d + Math.imul(A, en)) | 0),
            (r = (r + Math.imul(M, ec)) | 0),
            (f = ((f = (f + Math.imul(M, eh)) | 0) + Math.imul(w, ec)) | 0),
            (d = (d + Math.imul(w, eh)) | 0),
            (r = (r + Math.imul(v, eo)) | 0),
            (f = ((f = (f + Math.imul(v, eu)) | 0) + Math.imul(g, eo)) | 0),
            (d = (d + Math.imul(g, eu)) | 0);
          var eI =
            (((h + (r = (r + Math.imul(l, el)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(l, ep)) | 0) + Math.imul(p, el)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(p, ep)) | 0) + (f >>> 13)) | 0) +
              (eI >>> 26)) |
            0),
            (eI &= 67108863),
            (r = Math.imul(C, V)),
            (f = ((f = Math.imul(C, W)) + Math.imul(F, V)) | 0),
            (d = Math.imul(F, W)),
            (r = (r + Math.imul(L, U)) | 0),
            (f = ((f = (f + Math.imul(L, G)) | 0) + Math.imul(j, U)) | 0),
            (d = (d + Math.imul(j, G)) | 0),
            (r = (r + Math.imul(N, $)) | 0),
            (f = ((f = (f + Math.imul(N, ee)) | 0) + Math.imul(B, $)) | 0),
            (d = (d + Math.imul(B, ee)) | 0),
            (r = (r + Math.imul(R, ei)) | 0),
            (f = ((f = (f + Math.imul(R, er)) | 0) + Math.imul(k, ei)) | 0),
            (d = (d + Math.imul(k, er)) | 0),
            (r = (r + Math.imul(I, ed)) | 0),
            (f = ((f = (f + Math.imul(I, en)) | 0) + Math.imul(z, ed)) | 0),
            (d = (d + Math.imul(z, en)) | 0),
            (r = (r + Math.imul(_, ec)) | 0),
            (f = ((f = (f + Math.imul(_, eh)) | 0) + Math.imul(A, ec)) | 0),
            (d = (d + Math.imul(A, eh)) | 0),
            (r = (r + Math.imul(M, eo)) | 0),
            (f = ((f = (f + Math.imul(M, eu)) | 0) + Math.imul(w, eo)) | 0),
            (d = (d + Math.imul(w, eu)) | 0);
          var ez =
            (((h + (r = (r + Math.imul(v, el)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(v, ep)) | 0) + Math.imul(g, el)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(g, ep)) | 0) + (f >>> 13)) | 0) +
              (ez >>> 26)) |
            0),
            (ez &= 67108863),
            (r = Math.imul(C, U)),
            (f = ((f = Math.imul(C, G)) + Math.imul(F, U)) | 0),
            (d = Math.imul(F, G)),
            (r = (r + Math.imul(L, $)) | 0),
            (f = ((f = (f + Math.imul(L, ee)) | 0) + Math.imul(j, $)) | 0),
            (d = (d + Math.imul(j, ee)) | 0),
            (r = (r + Math.imul(N, ei)) | 0),
            (f = ((f = (f + Math.imul(N, er)) | 0) + Math.imul(B, ei)) | 0),
            (d = (d + Math.imul(B, er)) | 0),
            (r = (r + Math.imul(R, ed)) | 0),
            (f = ((f = (f + Math.imul(R, en)) | 0) + Math.imul(k, ed)) | 0),
            (d = (d + Math.imul(k, en)) | 0),
            (r = (r + Math.imul(I, ec)) | 0),
            (f = ((f = (f + Math.imul(I, eh)) | 0) + Math.imul(z, ec)) | 0),
            (d = (d + Math.imul(z, eh)) | 0),
            (r = (r + Math.imul(_, eo)) | 0),
            (f = ((f = (f + Math.imul(_, eu)) | 0) + Math.imul(A, eo)) | 0),
            (d = (d + Math.imul(A, eu)) | 0);
          var eq =
            (((h + (r = (r + Math.imul(M, el)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(M, ep)) | 0) + Math.imul(w, el)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(w, ep)) | 0) + (f >>> 13)) | 0) +
              (eq >>> 26)) |
            0),
            (eq &= 67108863),
            (r = Math.imul(C, $)),
            (f = ((f = Math.imul(C, ee)) + Math.imul(F, $)) | 0),
            (d = Math.imul(F, ee)),
            (r = (r + Math.imul(L, ei)) | 0),
            (f = ((f = (f + Math.imul(L, er)) | 0) + Math.imul(j, ei)) | 0),
            (d = (d + Math.imul(j, er)) | 0),
            (r = (r + Math.imul(N, ed)) | 0),
            (f = ((f = (f + Math.imul(N, en)) | 0) + Math.imul(B, ed)) | 0),
            (d = (d + Math.imul(B, en)) | 0),
            (r = (r + Math.imul(R, ec)) | 0),
            (f = ((f = (f + Math.imul(R, eh)) | 0) + Math.imul(k, ec)) | 0),
            (d = (d + Math.imul(k, eh)) | 0),
            (r = (r + Math.imul(I, eo)) | 0),
            (f = ((f = (f + Math.imul(I, eu)) | 0) + Math.imul(z, eo)) | 0),
            (d = (d + Math.imul(z, eu)) | 0);
          var eR =
            (((h + (r = (r + Math.imul(_, el)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(_, ep)) | 0) + Math.imul(A, el)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(A, ep)) | 0) + (f >>> 13)) | 0) +
              (eR >>> 26)) |
            0),
            (eR &= 67108863),
            (r = Math.imul(C, ei)),
            (f = ((f = Math.imul(C, er)) + Math.imul(F, ei)) | 0),
            (d = Math.imul(F, er)),
            (r = (r + Math.imul(L, ed)) | 0),
            (f = ((f = (f + Math.imul(L, en)) | 0) + Math.imul(j, ed)) | 0),
            (d = (d + Math.imul(j, en)) | 0),
            (r = (r + Math.imul(N, ec)) | 0),
            (f = ((f = (f + Math.imul(N, eh)) | 0) + Math.imul(B, ec)) | 0),
            (d = (d + Math.imul(B, eh)) | 0),
            (r = (r + Math.imul(R, eo)) | 0),
            (f = ((f = (f + Math.imul(R, eu)) | 0) + Math.imul(k, eo)) | 0),
            (d = (d + Math.imul(k, eu)) | 0);
          var ek =
            (((h + (r = (r + Math.imul(I, el)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(I, ep)) | 0) + Math.imul(z, el)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(z, ep)) | 0) + (f >>> 13)) | 0) +
              (ek >>> 26)) |
            0),
            (ek &= 67108863),
            (r = Math.imul(C, ed)),
            (f = ((f = Math.imul(C, en)) + Math.imul(F, ed)) | 0),
            (d = Math.imul(F, en)),
            (r = (r + Math.imul(L, ec)) | 0),
            (f = ((f = (f + Math.imul(L, eh)) | 0) + Math.imul(j, ec)) | 0),
            (d = (d + Math.imul(j, eh)) | 0),
            (r = (r + Math.imul(N, eo)) | 0),
            (f = ((f = (f + Math.imul(N, eu)) | 0) + Math.imul(B, eo)) | 0),
            (d = (d + Math.imul(B, eu)) | 0);
          var eP =
            (((h + (r = (r + Math.imul(R, el)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(R, ep)) | 0) + Math.imul(k, el)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(k, ep)) | 0) + (f >>> 13)) | 0) +
              (eP >>> 26)) |
            0),
            (eP &= 67108863),
            (r = Math.imul(C, ec)),
            (f = ((f = Math.imul(C, eh)) + Math.imul(F, ec)) | 0),
            (d = Math.imul(F, eh)),
            (r = (r + Math.imul(L, eo)) | 0),
            (f = ((f = (f + Math.imul(L, eu)) | 0) + Math.imul(j, eo)) | 0),
            (d = (d + Math.imul(j, eu)) | 0);
          var eN =
            (((h + (r = (r + Math.imul(N, el)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(N, ep)) | 0) + Math.imul(B, el)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(B, ep)) | 0) + (f >>> 13)) | 0) +
              (eN >>> 26)) |
            0),
            (eN &= 67108863),
            (r = Math.imul(C, eo)),
            (f = ((f = Math.imul(C, eu)) + Math.imul(F, eo)) | 0),
            (d = Math.imul(F, eu));
          var eB =
            (((h + (r = (r + Math.imul(L, el)) | 0)) | 0) +
              ((8191 &
                (f =
                  ((f = (f + Math.imul(L, ep)) | 0) + Math.imul(j, el)) | 0)) <<
                13)) |
            0;
          (h =
            ((((d = (d + Math.imul(j, ep)) | 0) + (f >>> 13)) | 0) +
              (eB >>> 26)) |
            0),
            (eB &= 67108863);
          var eE =
            (((h + (r = Math.imul(C, el))) | 0) +
              ((8191 & (f = ((f = Math.imul(C, ep)) + Math.imul(F, el)) | 0)) <<
                13)) |
            0;
          return (
            (h =
              ((((d = Math.imul(F, ep)) + (f >>> 13)) | 0) + (eE >>> 26)) | 0),
            (eE &= 67108863),
            (c[0] = em),
            (c[1] = ev),
            (c[2] = eg),
        ...
        Math.imul || (l = b),
            ...
            return 10 === this.length && 10 === e.length
              ...
              ? (function (e, t, i) {
                  ...
                  for (var r = 0, f = 0, d = 0; d < i.length - 1; d++) {
                    ...
                    for (
                      var a = 67108863 & r,
                        c = Math.min(d, t.length - 1),
                        h = Math.max(0, d - e.length + 1);
                      h <= c;
                      h++
                    ) {
                      var s = d - h,
                        o = (0 | e.words[s]) * (0 | t.words[h]),
                        u = 67108863 & o;
                      (n = (n + ((o / 67108864) | 0)) | 0),
                        (a = 67108863 & (u = (u + a) | 0)),
                        (f += (n = (n + (u >>> 26)) | 0) >>> 26),
          ...
          (m.prototype.makeRBT = function (e) {
            for (
              var t = Array(e), i = d.prototype._countBits(e) - 1, r = 0;
              r < e;
              r++
            )
          ...
          (m.prototype.revBin = function (e, t, i) {
            if (0 === e || e === i - 1) return e;
            for (var r = 0, f = 0; f < t; f++)
              (r |= (1 & e) << (t - f - 1)), (e >>= 1);
            return r;
          }),
          (m.prototype.permute = function (e, t, i, r, f, d) {
            for (var n = 0; n < d; n++) (r[n] = t[e[n]]), (f[n] = i[e[n]]);
          }),
          (m.prototype.transform = function (e, t, i, r, f, d) {
          ...
          (m.prototype.conjugate = function (e, t, i) {
            if (!(i <= 1))
              for (var r = 0; r < i / 2; r++) {
                var f = e[r];
                (e[r] = e[i - r - 1]),
          ...
          (m.prototype.normalize13b = function (e, t) {
            for (var i = 0, r = 0; r < t / 2; r++) {
              var f =
                ...
                i;
              (e[r] = 67108863 & f),
                (i = f < 67108864 ? 0 : (f / 67108864) | 0);
            }
            return e;
          }),
          (m.prototype.convert13b = function (e, t, i, f) {
            for (var d = 0, n = 0; n < t; n++)
              (d += 0 | e[n]),
                (i[2 * n] = 8191 & d),
                (d >>>= 13),
                (i[2 * n + 1] = 8191 & d),
                (d >>>= 13);
            for (n = 2 * t; n < f; ++n) i[n] = 0;
            r(0 === d), r((-8192 & d) == 0);
          }),
          ...
          (m.prototype.mulp = function (e, t, i) {
            var r = 2 * this.guessLen13b(e.length, t.length),
              ...
              u = i.words;
            (u.length = r),
              this.convert13b(e.words, e.length, n, r),
              this.convert13b(t.words, t.length, h, r),
              this.transform(n, d, a, c, r, f),
              this.transform(h, d, s, o, r, f);
            for (var b = 0; b < r; b++) {
              var l = a[b] * s[b] - c[b] * o[b];
              (c[b] = a[b] * o[b] + c[b] * s[b]), (a[b] = l);
            }
            return (
              this.conjugate(a, c, r),
              this.transform(a, c, u, d, r, f),
          ...
          (d.prototype.imuln = function (e) {
            ...
            for (var t = 0, i = 0; i < this.length; i++) {
              var f = (0 | this.words[i]) * e,
                d = (67108863 & f) + (67108863 & t);
              (t >>= 26),
                (t += ((f / 67108864) | 0) + (d >>> 26)),
          ...
          (d.prototype.pow = function (e) {
            ...
            if (++r < t.length)
              for (var f = i.sqr(); r < t.length; r++, f = f.sqr())
                0 !== t[r] && (i = i.mul(f));
            return i;
          }),
          (d.prototype.iushln = function (e) {
            ...
            var t,
              i = e % 26,
              f = (e - i) / 26,
              d = (67108863 >>> (26 - i)) << (26 - i);
            if (0 !== i) {
              var n = 0;
              for (t = 0; t < this.length; t++) {
                var a = this.words[t] & d,
                  c = ((0 | this.words[t]) - a) << i;
                (this.words[t] = c | n), (n = a >>> (26 - i));
              }
              n && ((this.words[t] = n), this.length++);
            }
            if (0 !== f) {
              for (t = this.length - 1; t >= 0; t--)
                this.words[t + f] = this.words[t];
              for (t = 0; t < f; t++) this.words[t] = 0;
              this.length += f;
            }
            return this.strip();
          }),
          ...
          (d.prototype.iushrn = function (e, t, i) {
            r("number" == typeof e && e >= 0),
              (f = t ? (t - (t % 26)) / 26 : 0);
            var f,
              d = e % 26,
              n = Math.min((e - d) / 26, this.length),
              a = 67108863 ^ ((67108863 >>> d) << d);
            if (((f -= n), (f = Math.max(0, f)), i)) {
              for (var c = 0; c < n; c++) i.words[c] = this.words[c];
              i.length = n;
            }
            if (0 === n);
            else if (this.length > n)
              for (this.length -= n, c = 0; c < this.length; c++)
                this.words[c] = this.words[c + n];
            else (this.words[0] = 0), (this.length = 1);
            var h = 0;
            for (c = this.length - 1; c >= 0 && (0 !== h || c >= f); c--) {
              var s = 0 | this.words[c];
              (this.words[c] = (h << (26 - d)) | (s >>> d)), (h = s & a);
            }
            return (
          ...
          (d.prototype.ishrn = function (e, t, i) {
          ...
          (d.prototype.iaddn = function (e) {
            return (r("number" == typeof e), r(e < 67108864), e < 0)
              ? this.isubn(-e)
              : 0 !== this.negative
          ...
          (d.prototype._ishlnsubmul = function (e, t, i) {
            var f,
              d,
              n = e.length + i;
            this._expand(n);
            ...
            for (f = 0; f < e.length; f++) {
              d = (0 | this.words[f + i]) + a;
              var c = (0 | e.words[f]) * t;
              (d -= 67108863 & c),
                (a = (d >> 26) - ((c / 67108864) | 0)),
                (this.words[f + i] = 67108863 & d);
            }
            for (; f < this.length - i; f++)
              (a = (d = (0 | this.words[f + i]) + a) >> 26),
                (this.words[f + i] = 67108863 & d);
            if (0 === a) return this.strip();
            for (r(-1 === a), a = 0, f = 0; f < this.length; f++)
              (a = (d = -(0 | this.words[f]) + a) >> 26),
          ...
          (d.prototype._wordDiv = function (e, t) {
            ...
            0 != (r = 26 - this._countBits(a)) &&
              ((n = n.ushln(r)), f.iushln(r), (a = 0 | n.words[n.length - 1]));
            var c = f.length - n.length;
            if ("mod" !== t) {
              ((i = new d(null)).length = c + 1), (i.words = Array(i.length));
              for (var h = 0; h < i.length; h++) i.words[h] = 0;
            }
            var s = f.clone()._ishlnsubmul(n, 1, c);
            0 === s.negative && ((f = s), i && (i.words[c] = 1));
            for (var o = c - 1; o >= 0; o--) {
              var u =
                (0 | f.words[n.length + o]) * 67108864 +
                (0 | f.words[n.length + o - 1]);
              for (
                u = Math.min((u / a) | 0, 67108863), f._ishlnsubmul(n, u, o);
                0 !== f.negative;

              )
                u--,
                  (f.negative = 0),
                  f._ishlnsubmul(n, 1, o),
            ...
            return (
              i && i.strip(),
              f.strip(),
              "div" !== t && 0 !== r && f.iushrn(r),
              { div: i || null, mod: f }
            );
          }),
          (d.prototype.divmod = function (e, t, i) {
            var f, n, a;
            return (r(!e.isZero()), this.isZero())
              ...
              ? ((a = this.neg().divmod(e, t)),
                "mod" !== t && (f = a.div.neg()),
                "div" !== t &&
                  ((n = a.mod.neg()), i && 0 !== n.negative && n.iadd(e)),
                { div: f, mod: n })
              : 0 === this.negative && 0 !== e.negative
              ...
              ? ((a = this.neg().divmod(e.neg(), t)),
                "div" !== t &&
                  ((n = a.mod.neg()), i && 0 !== n.negative && n.isub(e)),
                { div: a.div, mod: n })
          ...
          (d.prototype.modn = function (e) {
            r(e <= 67108863);
            for (var t = 67108864 % e, i = 0, f = this.length - 1; f >= 0; f--)
              i = (t * i + (0 | this.words[f])) % e;
            return i;
          }),
          (d.prototype.idivn = function (e) {
            r(e <= 67108863);
            for (var t = 0, i = this.length - 1; i >= 0; i--) {
              var f = (0 | this.words[i]) + 67108864 * t;
              (this.words[i] = (f / e) | 0), (t = f % e);
            }
            return this.strip();
          }),
          ...
          (d.prototype.egcd = function (e) {
            ...
            for (
              var f = new d(1), n = new d(0), a = new d(0), c = new d(1), h = 0;
              t.isEven() && i.isEven();

            )
              t.iushrn(1), i.iushrn(1), ++h;
            for (var s = i.clone(), o = t.clone(); !t.isZero(); ) {
              for (
                var u = 0, b = 1;
                (t.words[0] & b) == 0 && u < 26;
                ++u, b <<= 1
              ...
              if (u > 0)
                for (t.iushrn(u); u-- > 0; )
                  (f.isOdd() || n.isOdd()) && (f.iadd(s), n.isub(o)),
                    f.iushrn(1),
                    n.iushrn(1);
              for (
                var l = 0, p = 1;
              ...
              if (l > 0)
                for (i.iushrn(l); l-- > 0; )
                  (a.isOdd() || c.isOdd()) && (a.iadd(s), c.isub(o)),
                    a.iushrn(1),
                    c.iushrn(1);
              t.cmp(i) >= 0
                ? (t.isub(i), f.isub(a), n.isub(c))
                : (i.isub(t), a.isub(f), c.isub(n));
            }
          ...
          (d.prototype._invmp = function (e) {
            ...
            for (
              var n = new d(1), a = new d(0), c = f.clone();
              ...
              i.cmp(f) >= 0 ? (i.isub(f), n.isub(a)) : (f.isub(i), a.isub(n));
            }
            return 0 > (t = 0 === i.cmpn(1) ? n : a).cmpn(0) && t.iadd(e), t;
          }),
          ...
          (d.prototype.bincn = function (e) {
            ...
            for (var d = f, n = i; 0 !== d && n < this.length; n++) {
              var a = 0 | this.words[n];
              (a += d), (d = a >>> 26), (a &= 67108863), (this.words[n] = a);
            }
            return 0 !== d && ((this.words[n] = d), this.length++), this;
          }),
        ...
        (g.prototype._tmp = function () {
          ...
          (y.prototype.split = function (e, t) {
            ...
            var f = e.words[9];
            for (r = 10, t.words[t.length++] = 4194303 & f; r < e.length; r++) {
              var d = 0 | e.words[r];
          ...
          (_.prototype.sqrt = function (e) {
            ...
            if ((r(t % 2 == 1), 3 === t)) {
              var i = this.m.add(new d(1)).iushrn(2);
              return this.pow(e, i);
            }
            for (
              var f = this.m.subn(1), n = 0;
              !f.isZero() && 0 === f.andln(1);

            )
              n++, f.iushrn(1);
            r(!f.isZero());
            var a = new d(1).toRed(this),
              c = a.redNeg(),
              h = this.m.subn(1).iushrn(1),
              s = this.m.bitLength();
            for (
              s = new d(2 * s * s).toRed(this);
              0 !== this.pow(s, h).cmp(c);

            )
              s.redIAdd(c);
            for (
              var o = this.pow(s, f),
                u = this.pow(e, f.addn(1).iushrn(1)),
                b = this.pow(e, f),
                l = n;
              0 !== b.cmp(a);

            ) {
              for (var p = b, m = 0; 0 !== p.cmp(a); m++) p = p.redSqr();
              r(m < l);
              var v = this.pow(o, new d(1).iushln(l - m - 1));
              (u = u.redMul(v)), (o = v.redSqr()), (b = b.redMul(o)), (l = m);
            }
            return u;
          }),
          ...
          (_.prototype.pow = function (e, t) {
            ...
            for (0 === c && (c = 26), r = t.length - 1; r >= 0; r--) {
              for (var h = t.words[r], s = c - 1; s >= 0; s--) {
                var o = (h >> s) & 1;
                if ((f !== i[0] && (f = this.sqr(f)), 0 === o && 0 === n)) {
                  a = 0;
                  continue;
                }
                (n <<= 1),
    ...
    49351: function (e, t, i) {
      ...
      (t.BlockHash = d),
        ...
        (d.prototype.digest = function (e) {
          return (
            this.update(this._pad()), f(null === this.pending), this._digest(e)
          );
        }),
      ...
      r.inherits(s, h),
        ...
        (s.prototype._update = function (e, t) {
          ...
          (A = a(this.h[1], f, y)),
            ...
            (this.h[2] = a(this.h[3], s, m)),
            (this.h[3] = a(this.h[4], i, v)),
            (this.h[4] = a(this.h[0], r, g)),
            (this.h[0] = A);
        }),
    ...
    4684: function (e, t, i) {
      ...
      r.inherits(u, s),
        ...
        (u.prototype._update = function (e, t) {
          ...
          for (; r < i.length; r++)
            i[r] = n(i[r - 3] ^ i[r - 8] ^ i[r - 14] ^ i[r - 16], 1);
          var f = this.h[0],
            d = this.h[1],
            s = this.h[2],
            u = this.h[3],
          ...
          for (r = 0; r < i.length; r++) {
            var l = ~~(r / 20),
              p = c(n(f, 5), h(l, d, s, u), b, i[r], o[l]);
            (b = u), (u = s), (s = n(d, 30)), (d = f), (f = p);
          }
          (this.h[0] = a(this.h[0], f)),
            (this.h[1] = a(this.h[1], d)),
            (this.h[2] = a(this.h[2], s)),
    ...
    17795: function (e, t, i) {
      ...
      r.inherits(g, m),
        ...
        (g.prototype._update = function (e, t) {
          for (var i = this.W, r = 0; r < 16; r++) i[r] = e[t + r];
          for (; r < i.length; r++)
            i[r] = c(p(i[r - 2]), i[r - 7], l(i[r - 15]), i[r - 16]);
          var f = this.h[0],
            d = this.h[1],
            m = this.h[2],
            v = this.h[3],
            ...
            M = this.h[6],
            w = this.h[7];
          for (n(this.k.length === i.length), r = 0; r < i.length; r++) {
            var S = h(w, b(g), s(g, y, M), this.k[r], i[r]),
              _ = a(u(f), o(f, d, m));
            (w = M),
              (M = y),
              (y = g),
    ...
    54358: function (e, t, i) {
      ...
      r.inherits(y, v),
        ...
        (y.prototype._prepareBlock = function (e, t) {
          ...
          for (; r < i.length; r += 2) {
            var f = (function (e, t) {
                var i = n(e, t, 19) ^ n(t, e, 29) ^ c(e, t, 6);
              ...
              m = i[r - 32],
              v = i[r - 31];
            (i[r] = b(f, d, s, o, u, p, m, v)),
              (i[r + 1] = l(f, d, s, o, u, p, m, v));
          }
        }),
        (y.prototype._update = function (e, t) {
          ...
          var i = this.W,
            ...
            x = this.h[14],
            I = this.h[15];
          d(this.k.length === i.length);
          for (var z = 0; z < i.length; z += 2) {
            var q = x,
              R = I,
              k = (function (e, t) {
                var i = n(e, t, 14) ^ n(e, t, 18) ^ n(t, e, 9);
                return i < 0 && (i += 4294967296), i;
              })(y, M),
              P = (function (e, t) {
              ...
              N = (function (e, t, i, r, f) {
                var d = (e & i) ^ (~e & f);
                return d < 0 && (d += 4294967296), d;
              })(y, 0, w, 0, _, A),
              B = (function (e, t, i, r, f, d) {
                var n = (t & r) ^ (~t & d);
              ...
              j = i[z],
              O = i[z + 1],
              C = p(q, R, k, P, N, B, E, L, j, O),
              F = m(q, R, k, P, N, B, E, L, j, O);
            q = (function (e, t) {
              var i = n(e, t, 28) ^ n(t, e, 2) ^ n(t, e, 7);
              return i < 0 && (i += 4294967296), i;
            })(r, f);
            var T = o(
                q,
                ...
                (k = (function (e, t, i, r, f) {
                  var d = (e & i) ^ (e & f) ^ (i & f);
                  return d < 0 && (d += 4294967296), d;
                })(r, 0, c, 0, b, l)),
                (P = (function (e, t, i, r, f, d) {
                  var n = (t & r) ^ (t & d) ^ (r & d);
                  return n < 0 && (n += 4294967296), n;
                })(0, f, 0, h, 0, l))
              ),
    ...
    31964: function (e, t, i) {
      "use strict";
      var r = i(20015).rotr32;
      function f(e, t, i) {
        return (e & t) ^ (e & i) ^ (t & i);
      }
      (t.ft_1 = function (e, t, i, r) {
        ...
        (t.ch32 = function (e, t, i) {
          return (e & t) ^ (~e & i);
        }),
        (t.maj32 = f),
        (t.p32 = function (e, t, i) {
          return e ^ t ^ i;
        }),
        (t.s0_256 = function (e) {
    ...
    20015: function (e, t, i) {
      ...
      (t.inherits = f),
        (t.toArray = function (e, t) {
              ...
              for (var r = 0, f = 0; f < e.length; f++) {
                ...
                a < 128
                  ...
                  : (a < 2048
                      ...
                      : (((d = e),
                        (n = f),
                        (64512 & d.charCodeAt(n)) != 55296 ||
                        n < 0 ||
                        n + 1 >= d.length
                          ? 1
                          : (64512 & d.charCodeAt(n + 1)) != 56320)
                          ? (i[r++] = (a >> 12) | 224)
                          : ((a =
                              65536 +
                              ((1023 & a) << 10) +
          ...
          } else for (f = 0; f < e.length; f++) i[f] = 0 | e[f];
          return i;
        }),
        (t.toHex = function (e) {
        ...
        (t.toHex32 = function (e, t) {
          for (var i = "", r = 0; r < e.length; r++) {
            var f = e[r];
            "little" === t && (f = d(f)), (i += a(f.toString(16)));
          }
          return i;
        }),
        (t.zero2 = n),
        (t.zero8 = a),
        (t.join32 = function (e, t, i, f) {
          var d,
            n = i - t;
          r(n % 4 == 0);
          for (var a = Array(n / 4), c = 0, h = t; c < a.length; c++, h += 4)
            (d =
              "big" === f
                ? (e[h] << 24) | (e[h + 1] << 16) | (e[h + 2] << 8) | e[h + 3]
                : (e[h + 3] << 24) | (e[h + 2] << 16) | (e[h + 1] << 8) | e[h]),
              (a[c] = d >>> 0);
          return a;
        }),
        (t.split32 = function (e, t) {
          for (
            var i = Array(4 * e.length), r = 0, f = 0;
            r < e.length;
            r++, f += 4
          ) {
            var d = e[r];
        ...
        (t.sum32_5 = function (e, t, i, r, f) {
          return (e + t + i + r + f) >>> 0;
        }),
        (t.sum64 = function (e, t, i, r) {
          var f = e[t],
            d = (r + e[t + 1]) >>> 0;
          (e[t] = ((d < r ? 1 : 0) + i + f) >>> 0), (e[t + 1] = d);
        }),
        ...
        (t.sum64_4_hi = function (e, t, i, r, f, d, n, a) {
          var c,
            h = t;
          return (
            (e +
        ...
        (t.sum64_4_lo = function (e, t, i, r, f, d, n, a) {
          return (t + r + d + a) >>> 0;
        }),
        (t.sum64_5_hi = function (e, t, i, r, f, d, n, a, c, h) {
          var s,
            o = t;
          return (
            (e +
        ...
        (t.sum64_5_lo = function (e, t, i, r, f, d, n, a, c, h) {
          return (t + r + d + a + h) >>> 0;
        }),
    ...
    28072: function (e, t, i) {
      ...
      function n(e) {
        ...
        var t = f.toArray(e.entropy, e.entropyEnc || "hex"),
          i = f.toArray(e.nonce, e.nonceEnc || "hex"),
          r = f.toArray(e.pers, e.persEnc || "hex");
        d(
      ...
      (e.exports = n),
        ...
        (n.prototype.generate = function (e, t, i, r) {
          ...
          "string" != typeof t && ((r = i), (i = t), (t = null)),
            i && ((i = f.toArray(i, r || "hex")), this._update(i));
          for (var d = []; d.length < e; )
            (this.V = this._hmac().update(this.V).digest()),
              (d = d.concat(this.V));
          var n = d.slice(0, e);
          return this._update(i), this._reseed++, f.encode(n, t);
        });
    },
    56853: function (e) {

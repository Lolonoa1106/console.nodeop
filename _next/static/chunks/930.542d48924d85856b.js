          ...
          (function (t, e, r, o) {
            ...
            let w = (function (t, e, r) {
                ...
                return (function (t, e, r) {
                  ...
                  for (o = 0; o < C; o++)
                    for (i = 0; i < l; i++)
                      o < E[i].length && (A[N++] = E[i][o]);
                  for (o = 0; o < m; o++)
                    for (i = 0; i < l; i++) A[N++] = v[i][o];
                  return A;
                })(o, t, e);
              })(e, r, d),
                ...
                for (let t = 0; t < s.length; t++) {
                  ...
                  for (let t = 0; t < i.length; t++) {
                    ...
                    r[a] && r[a].node.mode === u.mode
                      ? ((o[a][c] =
                          g(r[a].lastCount + u.length, u.mode) -
                          g(r[a].lastCount, u.mode)),
          ...
          for (let e = 0; e < s; e++)
            for (let r = 0; r < s; r++) {
              ...
              e >= l &&
                ...
                (h =
                  u[
                    i[Math.floor((e - l) / a) * o + Math.floor((r - l) / a)]
                      ? 1
                      : 0
                  ]),
                (t[c++] = h.r),
          ...
          return (
            ...
            Object.entries(p)
              ...
              .forEach(([t, e]) => {
                e.forEach((e) => {
                  s.push(
                    (0, n.YP)`<circle cx=${t} cy=${e} fill=${o} r=${u / 2.5} />`
                  );
                });
              }),
            Object.entries(p)
    ...
    `;
        ...
        templateVisual() {
          return this.imageSrc
            ? (0, n.dy)`<wui-image src=${this.imageSrc} alt=${
                this.alt ?? "logo"
              }></wui-image>`
            : this.farcaster
            ? (0, n.dy)`<wui-icon

  ...
  [3814],
  {
    64024: function (e, t, r) {
        ...
        drainKeysFoundInLookupTable(e, t) {
          ...
          for (let [n, s] of this.keyMetaMap.entries())
            if (t(s)) {
              ...
              s >= 0 &&
                (E(s < 256, "Max lookup table index exceeded"),
                r.push(s),
                i.push(t),
      ...
      class O {
        ...
        static compile(e) {
          let t = L.compile(e.instructions, e.payerKey),
            r = [],
            i = { writable: [], readonly: [] };
        ...
        static deserialize(e) {
          let t = [...e],
            r = G(t),
            i = 127 & r;
          E(r !== i, "Expected versioned message but received legacy message"),
            E(
              0 === i,
              `Expected versioned message with version 0 but found version ${i}`
            );
          let n = {
              numRequiredSignatures: G(t),
              numReadonlySignedAccounts: G(t),
              numReadonlyUnsignedAccounts: G(t),
            },
            s = [],
            a = T(t);
          for (let e = 0; e < a; e++) s.push(new _(Z(t, 0, 32)));
          let o = u().encode(Z(t, 0, 32)),
            c = T(t),
            l = [];
          for (let e = 0; e < c; e++) {
            let e = G(t),
      ...
      let J = i.Buffer.alloc(64).fill(0);
      class X {
        constructor(e) {
          (this.keys = void 0),
      ...
      class M {
        ...
        compileMessage() {
          ...
          return (
            p.forEach((e) => {
              E(e.programIdIndex >= 0), e.accounts.forEach((e) => E(e >= 0));
            }),
            new j({
              header: {
...
Missing signature for public key${
        ...
        _serialize(e) {
          ...
          return (
            ...
            t.forEach(({ signature: e }, t) => {
              null !== e &&
                (E(64 === e.length, "signature has invalid length"),
                i.Buffer.from(e).copy(s, r.length + 64 * t));
            }),
            e.copy(s, r.length + 64 * t.length),
            E(s.length <= 1232, `Transaction too large: ${s.length} > 1232`),
            s
          );
        }
        get keys() {
          return (
            E(1 === this.instructions.length),
            this.instructions[0].keys.map((e) => e.pubkey)
          );
        }
        get programId() {
          return (
            E(1 === this.instructions.length), this.instructions[0].programId
          );
        }
        get data() {
          return E(1 === this.instructions.length), this.instructions[0].data;
        }
        static from(e) {
          let t = [...e],
            r = T(t),
      ...
      let C = new _("SysvarC1ock11111111111111111111111111111111");
      new _("SysvarEpochSchedu1e111111111111111111111111"),
        new _("Sysvar1nstructions1111111111111111111111111");
      let U = new _("SysvarRecentB1ockHashes11111111111111111111"),
        N = new _("SysvarRent111111111111111111111111111111111");
      ...
      let $ = new _("SysvarStakeHistory1111111111111111111111111");
...
` +
      ...
      let D = d._O("lamportsPerSignature"),
        Q = d.n_([
          d.Jq("version"),
          d.Jq("state"),
          P("authorizedPubkey"),
          P("nonce"),
          d.n_([D], "feeCalculator"),
        ]).span;
      function Y(e) {
        let t = (0, d.Ik)(8, e),
          r = t.decode.bind(t),
      ...
      let ee = Object.freeze({
        ...
        Transfer: {
          index: 2,
          layout: d.n_([d.Jq("instruction"), Y("lamports")]),
        },
        CreateWithSeed: {
          index: 3,
          layout: d.n_([
      ...
      class et {
        ...
        static transfer(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = H(ee.Transfer, { lamports: BigInt(e.lamports) })),
                (r = [
                  { pubkey: e.fromPubkey, isSigner: !0, isWritable: !0 },
                  { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
                ])),
        ...
        static assign(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = H(ee.Assign, { programId: x(e.programId.toBuffer()) })),
                (r = [
        ...
        static nonceInitialize(e) {
          let t = H(ee.InitializeNonceAccount, {
        ...
        static nonceAdvance(e) {
          let t = H(ee.AdvanceNonceAccount);
          return new X({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: U, isSigner: !1, isWritable: !1 },
        ...
        static nonceWithdraw(e) {
          let t = H(ee.WithdrawNonceAccount, { lamports: e.lamports });
          return new X({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
        ...
        static nonceAuthorize(e) {
          let t = H(ee.AuthorizeNonceAccount, {
      ...
      et.programId = new _("11111111111111111111111111111111");
      class er {
        constructor() {}
        static getMinNumSignatures(e) {
          return 2 * (Math.ceil(e / er.chunkSize) + 1 + 1);
        }
        static async load(e, t, r, n, s) {
          {
            ...
            if (null !== a) {
              ...
              a.data.length !== s.length &&
                (o = o || new M()).add(
                  et.allocate({ accountPubkey: r.publicKey, space: s.length })
                ),
                a.owner.equals(n) ||
                  (o = o || new M()).add(
                    et.assign({ accountPubkey: r.publicKey, programId: n })
                  ),
                a.lamports < i &&
                  (o = o || new M()).add(
                    et.transfer({
            ...
            null !== o && (await V(e, o, [t, r], { commitment: "confirmed" }));
          }
          let a = d.n_([
              d.Jq("instruction"),
              d.Jq("offset"),
          ...
          for (; c.length > 0; ) {
            ...
            l.push(V(e, h, [t, r], { commitment: "confirmed" })),
      ...
      let ei = (0, g.oQ)((0, g.eE)(_), (0, g.Z_)(), (e) => new _(e)),
        en = (0, g.bc)([(0, g.Z_)(), (0, g.i0)("base64")]),
        es = (0, g.oQ)((0, g.eE)(i.Buffer), en, (e) =>
      ...
      let eh = (0, g.IX)(
        ...
        eb = (0, g.IM)((0, g.Z_)(), (0, g.IX)((0, g.Rx)())),
        em = (0, g.AG)((0, g.G0)([(0, g.dt)({}), (0, g.Z_)()])),
        ef = (0, g.dt)({ err: em }),
        ek = (0, g.i0)("receivedSignature");
      (0, g.dt)({
        "solana-core": (0, g.Z_)(),
      ...
      ec(
          ...
          innerInstructions: (0, g.jt)(
            (0, g.AG)(
              (0, g.IX)(
                (0, g.dt)({
                  index: (0, g.Rx)(),
                  instructions: (0, g.IX)((0, g.G0)([eI, ex])),
                })
              )
            )
          ),
        ...
        ec(
          (0, g.dt)({
            ...
            nonCirculatingAccounts: (0, g.IX)(ei),
          })
        );
      let eS = (0, g.dt)({
        amount: (0, g.Z_)(),
      ...
      ec(
        ...
        ec((0, g.IX)((0, g.dt)({ lamports: (0, g.Rx)(), address: ei })));
      let eA = (0, g.dt)({
        executable: (0, g.O7)(),
        owner: ei,
        lamports: (0, g.Rx)(),
      ...
      (0, g.dt)({ pubkey: ei, account: eA });
      let e_ = (0, g.oQ)(
          (0, g.G0)([(0, g.eE)(i.Buffer), ew]),
          (0, g.G0)([en, ew]),
          (e) => (Array.isArray(e) ? (0, g.Ue)(e, es) : e)
        ),
        eR = (0, g.dt)({
          executable: (0, g.O7)(),
          owner: ei,
      ...
      (0, g.dt)({ pubkey: ei, account: eR }),
        ...
        (0, g.dt)({ subscription: (0, g.Rx)(), result: el(eA) });
      let ev = (0, g.dt)({ pubkey: ei, account: eA });
      (0, g.dt)({ subscription: (0, g.Rx)(), result: el(ev) });
      let eB = (0, g.dt)({
        parent: (0, g.Rx)(),
        slot: (0, g.Rx)(),
        root: (0, g.Rx)(),
      });
      (0, g.dt)({ subscription: (0, g.Rx)(), result: eB });
      let eW = (0, g.G0)([
        (0, g.dt)({
          type: (0, g.G0)([
      ...
      (0, g.dt)({ subscription: (0, g.Rx)(), result: eW }),
        (0, g.dt)({
          subscription: (0, g.Rx)(),
          result: el((0, g.G0)([ef, ek])),
        }),
      ...
      eu((0, g.dt)({ current: (0, g.IX)(eP), delinquent: (0, g.IX)(eP) }));
      let eK = (0, g.G0)([
          (0, g.i0)("processed"),
          (0, g.i0)("confirmed"),
          (0, g.i0)("finalized"),
        ...
        eT = (0, g.dt)({
          ...
          err: em,
          confirmationStatus: (0, g.jt)(eK),
        });
      ec((0, g.IX)((0, g.AG)(eT))), eu((0, g.Rx)());
      let ez = (0, g.dt)({
          accountKey: ei,
        ...
        eE = (0, g.dt)({
          ...
          message: (0, g.dt)({
            ...
            addressTableLookups: (0, g.jt)((0, g.IX)(ez)),
          }),
        }),
        eL = (0, g.dt)({
          pubkey: ei,
        ...
        eJ = (0, g.oQ)(ej, eO, (e) =>
          "accounts" in e ? (0, g.Ue)(e, eZ) : (0, g.Ue)(e, eG)
        ),
        eX = (0, g.dt)({
          signatures: (0, g.IX)((0, g.Z_)()),
          message: (0, g.dt)({
            accountKeys: (0, g.IX)(eL),
            instructions: (0, g.IX)(eJ),
            recentBlockhash: (0, g.Z_)(),
            addressTableLookups: (0, g.jt)((0, g.AG)((0, g.IX)(ez))),
          }),
        }),
        eM = (0, g.dt)({
          accountIndex: (0, g.Rx)(),
        ...
        eC = (0, g.dt)({ writable: (0, g.IX)(ei), readonly: (0, g.IX)(ei) }),
        eU = (0, g.dt)({
          err: em,
          fee: (0, g.Rx)(),
          innerInstructions: (0, g.jt)(
          ...
          preTokenBalances: (0, g.jt)((0, g.AG)((0, g.IX)(eM))),
          postTokenBalances: (0, g.jt)((0, g.AG)((0, g.IX)(eM))),
          loadedAddresses: (0, g.jt)(eC),
          computeUnitsConsumed: (0, g.jt)((0, g.Rx)()),
          costUnits: (0, g.jt)((0, g.Rx)()),
        }),
        eN = (0, g.dt)({
          err: em,
          fee: (0, g.Rx)(),
          innerInstructions: (0, g.jt)(
            (0, g.AG)(
              (0, g.IX)(
                (0, g.dt)({ index: (0, g.Rx)(), instructions: (0, g.IX)(eJ) })
              )
            )
          ),
          preBalances: (0, g.IX)((0, g.Rx)()),
        ...
        e$ = (0, g.G0)([(0, g.i0)(0), (0, g.i0)("legacy")]),
        eF = (0, g.dt)({
          pubkey: (0, g.Z_)(),
          lamports: (0, g.Rx)(),
        ...
        eu(
          (0, g.AG)(
            (0, g.dt)({
              ...
              parentSlot: (0, g.Rx)(),
              transactions: (0, g.IX)(
                (0, g.dt)({ transaction: eE, meta: (0, g.AG)(eU) })
              ),
              rewards: (0, g.jt)((0, g.IX)(eF)),
              blockTime: (0, g.AG)((0, g.Rx)()),
            })
      ...
      (0, g.dt)({ result: el(eH), subscription: (0, g.Rx)() });
      class eD {
        constructor(e) {
        ...
        static fromSecretKey(e, t) {
          ...
          return new eD({ publicKey: r, secretKey: e });
        }
        static fromSeed(e) {
          let t = m(e),
            r = new Uint8Array(64);
          return r.set(e), r.set(t, 32), new eD({ publicKey: t, secretKey: r });
        }
        get publicKey() {
      ...
      class eY {
        ...
        static createLookupTable(e) {
          let [t, r] = _.findProgramAddressSync(
            ...
            n = [
              ...
              { pubkey: et.programId, isSigner: !1, isWritable: !1 },
            ];
          return [new X({ programId: this.programId, keys: n, data: i }), t];
        }
        static freezeLookupTable(e) {
          let t = H(eQ.FreezeLookupTable),
            r = [
        ...
        static deactivateLookupTable(e) {
          let t = H(eQ.DeactivateLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
      ...
      eY.programId = new _("AddressLookupTab1e1111111111111111111111111");
      let e0 = Object.freeze({
        ...
        SetComputeUnitPrice: {
          index: 3,
          layout: d.n_([d.u8("instruction"), Y("microLamports")]),
        },
      });
      class e1 {
        constructor() {}
        static requestUnits(e) {
          let t = H(e0.RequestUnits, e);
          return new X({ keys: [], programId: this.programId, data: t });
        }
        static requestHeapFrame(e) {
          let t = H(e0.RequestHeapFrame, e);
          return new X({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitLimit(e) {
          let t = H(e0.SetComputeUnitLimit, e);
          return new X({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitPrice(e) {
          let t = H(e0.SetComputeUnitPrice, {
            microLamports: BigInt(e.microLamports),
          });
          return new X({ keys: [], programId: this.programId, data: t });
        }
      }
      e1.programId = new _("ComputeBudget111111111111111111111111111111");
      let e8 = d.n_([
        d.u8("numSignatures"),
        d.u8("padding"),
      ...
      class e2 {
        ...
        static createInstructionWithPublicKey(e) {
          ...
          return (
            ...
            c.fill(n, o),
            c.fill(r, u),
            new X({ keys: [], programId: e2.programId, data: c })
          );
        }
      ...
      e2.programId = new _("Ed25519SigVerify111111111111111111111111111");
      let e3 = (e, t) => {
        let r = y.kA.sign(e, t);
        return [r.toCompactRawBytes(), r.recovery];
      };
      y.kA.utils.isValidPrivateKey;
      let e4 = y.kA.getPublicKey,
        e6 = d.n_([
          d.u8("numSignatures"),
          d.KB("signatureOffset"),
      ...
      class e5 {
        ...
        static createInstructionWithPublicKey(e) {
          ...
          return e5.createInstructionWithEthAddress({
            ethAddress: e5.publicKeyToEthAddress(t),
            message: r,
            signature: i,
            recoveryId: n,
            instructionIndex: s,
        ...
        static createInstructionWithEthAddress(e) {
          ...
          let u = 12 + t.length,
            c = u + s.length + 1,
            l = i.Buffer.alloc(e6.span + n.length);
          return (
            e6.encode(
              {
                numSignatures: 1,
            ...
            l.fill(x(n), e6.span),
            new X({ keys: [], programId: e5.programId, data: l })
          );
        }
        static createInstructionWithPrivateKey(e) {
      ...
      e5.programId = new _("KeccakSecp256k11111111111111111111111111111");
      let e7 = new _("StakeConfig11111111111111111111111111111111");
      class e9 {
        constructor(e, t, r) {
      ...
      e9.default = new e9(0, 0, _.default);
      ...
      class tt {
        ...
        static authorize(e) {
          ...
          return (
            ...
            new M().add({ keys: o, programId: this.programId, data: a })
          );
        }
        static authorizeWithSeed(e) {
          ...
          return (
            ...
            new M().add({ keys: c, programId: this.programId, data: u })
          );
        }
      ...
      (tt.programId = new _("Stake11111111111111111111111111111111111111")),
        (tt.space = 200);
      ...
      class ti {
        ...
        static updateValidatorIdentity(e) {
          let {
            ...
            n = H(tr.UpdateValidatorIdentity);
          return new M().add({
            keys: [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: i, isSigner: !0, isWritable: !1 },
      ...
      (ti.programId = new _("Vote111111111111111111111111111111111111111")),
        (ti.space = 3762),

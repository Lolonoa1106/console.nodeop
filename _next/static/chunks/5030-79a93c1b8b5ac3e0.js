  ...
  [5030],
  {
    ...
    12846: function (e, t, n) {
      ...
      function D(e) {
        ...
        let { canonicalUrl: L } = (0, s.useUnwrapState)(I),
          { searchParams: F, pathname: H } = (0, u.useMemo)(() => {
            let e = new URL(
              L,
        ...
        if (B.mpaNavigation) {
          if (w.pendingMpaPath !== L) {
            ...
            B.pendingPush ? e.assign(L) : e.replace(L), (w.pendingMpaPath = L);
          }

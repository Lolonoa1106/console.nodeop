...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3010],
  {
    26228: function (e, t, n) {
        ...
        b = function (e) {
          for (var t = "", n = 0; n < e.length; n++) {
            ...
            i < 128
              ...
              : i > 127 && i < 2048
              ? (t +=
                  String.fromCharCode((i >> 6) | 192) +
                  String.fromCharCode((63 & i) | 128))
              : (t +=
                  String.fromCharCode((i >> 12) | 224) +
          ...
          for (var t = "", n = 0, i = 0, r = 0; n < e.length; )
            (i = e.charCodeAt(n)) < 128
              ...
              ? ((t += String.fromCharCode(
                  ((31 & i) << 6) | (63 & e.charCodeAt(n + 1))
                )),
                (n += 2))
              : ((t += String.fromCharCode(
                  ((15 & i) << 12) |
                    ((63 & e.charCodeAt(n + 1)) << 6) |
                    (63 & e.charCodeAt(n + 2))
                )),
                (n += 3));
          return t;
        ...
        R = {
          ...
          _decode: function (e) {
            ...
            for (e = e.replace(/[^A-Za-z0-9+/=]/g, ""); p < e.length; )
              (r = R._keyStr.indexOf(e.charAt(p++))),
                (o = R._keyStr.indexOf(e.charAt(p++))),
                (s = R._keyStr.indexOf(e.charAt(p++))),
                (a = R._keyStr.indexOf(e.charAt(p++))),
                (t = (r << 2) | (o >> 4)),
                (n = ((15 & o) << 4) | (s >> 2)),
                (i = ((3 & s) << 6) | a),
      ...
      var k = { DISABLE: 0, ERROR: 1, WARN: 2, INFO: 3 },
        P = k.WARN,
        D = {
          error: function (e) {
            P >= k.ERROR && U(e);
        ...
        x = ["nan", "function", "arguments", "regexp", "element"],
        q = function e(t, n) {
          var i = C(n);
          if (-1 !== x.indexOf(i))
            D.warn(
            ...
            for (var r = [], o = 0; o < n.length; o++) {
              ...
              "object" === a ? r.push(M(s)) : r.push(e(t, s));
            }
            n = r;
          } else "object" === i && (n = M(n));
          return n;
        ...
        G = {
          setLogLevel: function (e) {
            Object.prototype.hasOwnProperty.call(k, e) && (P = k[e]);
          },
          log: D,
          ...
          truncate: function e(t) {
            if ("array" === C(t))
              ...
              t =
                "string" === C((n = t)) && n.length > N.MAX_STRING_LENGTH
          ...
          validateSessionId: function (e) {
            return (
              !!(w(e, "sessionId", "number") && new Date(e).getTime() > 0) ||
              (D.error(
          ...
          getHost: function (e) {
            var t = T.location ? T.location.hostname : "";
            if (e) {
        ...
        K = function () {
          ...
          return (n && (e = parseInt(n, 32)), e)
            ? e
            : (G.log.warn("unable to parse malformed cookie: ".concat(t)), 0);
        },
        F = {
          set: V,
          get: L,
          ...
          areCookiesEnabled: function () {
            ...
            try {
              ...
              V(t, i, e),
                G.log.info("Testing if cookies available"),
                (n = L(t + "=") === i);
            } catch (e) {
              G.log.warn(
              ...
              G.log.info("Cleaning up cookies availability test"),
                V(t, null, e);
            }
            return n;
          },
        ...
        W = function (e) {
          var t = G.getHost(e).split("."),
            n = [],
            i = "_tldtest_" + X();
          if (G.isWebWorkerEnvironment()) return "";
          for (var r = t.length - 2; r >= 0; --r) n.push(t.slice(r).join("."));
          for (var o = 0; o < n.length; ++o) {
            var s = n[o],
              a = { domain: "." + s };
            if ((F.set(i, 1, a), F.get(i))) return F.set(i, null, a), s;
          }
          return "";
        },
        ...
        Y = function (e) {
          ...
          return (
            B.domain &&
              (t =
                "." === B.domain.charAt(0) ? B.domain.substring(1) : B.domain),
            e + t
          );
        },
        H = function (e) {
          var t = Y(e) + "=",
            n = F.get(t);
          try {
            if (n) return JSON.parse(R.decode(n));
          } catch (e) {}
          return null;
        },
        $ = function (e, t) {
          try {
            return F.set(Y(e), R.encode(JSON.stringify(t)), B), !0;
          } catch (e) {
            return !1;
          }
        },
        ...
        J = {
          ...
          options: function (e) {
            ...
            (e = e || {}),
              ...
              (B.secure = e.secure),
              (B.sameSite = e.sameSite);
            var t = G.isEmptyString(e.domain)
                ? "." + W(G.getLocation().href)
                : e.domain,
              n = Math.random();
            (B.domain = t), $("amplitude_test", n);
      ...
      if (
        (function () {
          ...
          try {
            return (
              T.localStorage.setItem(t, t),
              (e = T.localStorage.getItem(t) === String(t)),
        ...
        i = T.localStorage;
      else if (void 0 !== T && T.globalStorage)
        try {
          i = T.globalStorage[T.location.hostname];
        } catch (e) {}
      ...
      } else G.isWebWorkerEnvironment() && (i = new z());
      i ||
        (i = {
          length: 0,
          setItem: function (e, t) {},
      ...
      en.prototype.getStorage = function (e) {
        if (null !== this.storage) return this.storage;
        if (!e && F.areCookiesEnabled()) this.storage = J;
        else {
              ...
              return 0 == arguments.length
                ...
                : ((e = e || {}),
                  ...
                  (this._options.domain =
                    e.domain ||
                    this._options.domain ||
                    (T && T.location && T.location.hostname)),
                  (this._options.secure = e.secure || !1));
            },
            get: function (e) {
              try {
                return JSON.parse(et.getItem(t + e));
              } catch (e) {}
              return null;
            },
            set: function (e, n) {
              try {
                return et.setItem(t + e, JSON.stringify(n)), !0;
              } catch (e) {}
              return !1;
            },
            remove: function (e) {
      ...
      var ei =
          (m((r = {}), N.STORAGE_COOKIES, !0),
          m(r, N.STORAGE_NONE, !0),
          m(r, N.STORAGE_LOCAL, !0),
          m(r, N.STORAGE_SESSION, !0),
          r),
        er = (function () {
          function e(t) {
            var n = t.storageKey,
            ...
            g(this, e),
              ...
              (this.cookieDomain = "");
            var p = G.getLocation() ? G.getLocation().href : void 0,
              c = i ? "" : W(p);
            (this.cookieDomain = r || (c ? "." + c : null)),
              ei[u]
                ? (this.storage = u)
                : i ||
                  !F.areCookiesEnabled({
          ...
          return (
            _(e, [
                  ...
                  if (this.storage !== N.STORAGE_NONE) {
                    ...
                    switch (this.storage) {
                      case N.STORAGE_SESSION:
                        T.sessionStorage &&
                          T.sessionStorage.setItem(this.storageKey, p);
                        break;
                      case N.STORAGE_LOCAL:
                        et.setItem(this.storageKey, p);
                        break;
              ...
              },
              {
                key: "saveCookie",
                value: function (e) {
                  F.set(this.getCookieStorageKey(), e, {
                    domain: this.cookieDomain,
                    secure: this.secure,
                    sameSite: this.sameSite,
                    expirationDays: this.expirationDays,
                ...
                value: function () {
                  ...
                  if (this.storage === N.STORAGE_COOKIES) {
                    ...
                    if (0 === i.length || 1 === i.length) e = i[0];
                      ...
                      var r = F.sortByEventTime(i)[0];
                      i.forEach(function () {
                        return F.set(t.getCookieStorageKey(), null, {});
                      }),
                        this.saveCookie(r),
                        (e = F.get(n));
                    }
                  }
                  if ((e || (e = et.getItem(this.storageKey)), !e))
                    try {
                      e =
                        T.sessionStorage &&
                  ...
                  var o = e.split("."),
                    s = null;
                  if (o[N.USER_ID_INDEX])
                    try {
                      s = R.decode(o[N.USER_ID_INDEX]);
                    } catch (e) {
                      s = null;
                    }
                  return {
                    deviceId: o[N.DEVICE_ID_INDEX],
                    userId: s,
                    optOut: "1" === o[N.OPT_OUT_INDEX],
                    sessionId: parseInt(o[N.SESSION_ID_INDEX], 32),
                    lastEventTime: parseInt(o[N.LAST_EVENT_TIME_INDEX], 32),
                    eventId: parseInt(o[N.EVENT_ID_INDEX], 32),
                    identifyId: parseInt(o[N.IDENTIFY_ID_INDEX], 32),
                    sequenceNumber: parseInt(o[N.SEQUENCE_NUMBER_INDEX], 32),
                  };
                },
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    (this.storage === N.STORAGE_COOKIES &&
                      ((e = F.get(this.getCookieStorageKey() + "=")),
                      F.set(this.getCookieStorageKey(), null, {
                        domain: this.cookieDomain,
                        secure: this.secure,
                        sameSite: this.sameSite,
                        expirationDays: 0,
                      })),
                    e || ((e = et.getItem(this.storageKey)), et.clear()),
                    !e)
                  )
                    try {
                      (e =
        ...
        eo = function (e, t) {
          var n = e ? "?" + e.split(".").slice(-1)[0].replace(/\|/g, "&") : "",
            i = function (e, t, n, i) {
              return G.getQueryParam(e, t) || G.getQueryParam(n, i);
            },
            r = i(N.UTM_SOURCE, t, "utmcsr", n),
            o = i(N.UTM_MEDIUM, t, "utmcmd", n),
            s = i(N.UTM_CAMPAIGN, t, "utmccn", n),
            a = i(N.UTM_TERM, t, "utmctr", n),
            u = i(N.UTM_CONTENT, t, "utmcct", n),
            p = {},
            c = function (e, t) {
              G.isEmptyString(t) || (p[e] = t);
            };
          return (
            c(N.UTM_SOURCE, r),
            c(N.UTM_MEDIUM, o),
        ...
        (ea.prototype.clearAll = function () {
          return (
            Object.keys(this.userPropertiesOperations).length > 0
              ...
              : (this.userPropertiesOperations[es] = "-"),
            this
          );
        }),
      ...
      eu.prototype.send = function (e) {
        if (T.XDomainRequest) {
          ...
          t.open("POST", this.url, !0),
            ...
            t.send(u.Z.stringify(this.data));
          ...
          n.open("POST", this.url, !0),
            ...
            n.send(u.Z.stringify(this.data));
        } else {
          var i = void 0;
          fetch(this.url, {
            method: "POST",
            headers: this.headers,
            body: u.Z.stringify(this.data),
          })
            .then(function (e) {
      ...
      (ep.prototype.setProductId = function (e) {
        return (
          "string" !== C(e)
            ? G.log.error(
                "Unsupported type for productId: " + C(e) + ", expecting string"
              )
            : G.isEmptyString(e)
        ...
        (ep.prototype.setQuantity = function (e) {
          return (
            "number" !== C(e)
              ? G.log.error(
        ...
        (ep.prototype.setPrice = function (e) {
          return (
            "number" !== C(e)
              ? G.log.error(
                  "Unsupported type for price: " + C(e) + ", expecting number"
                )
              : (this._price = e),
            this
          );
        }),
        (ep.prototype.setRevenueType = function (e) {
          return (
            "string" !== C(e)
              ? G.log.error(
        ...
        (ep.prototype.setEventProperties = function (e) {
          return (
            "object" !== C(e)
              ? G.log.error(
        ...
        (ep.prototype._isValidRevenue = function () {
          return (
            "number" === C(this._price) ||
            (G.log.error("Invalid revenue, need to set price field"), !1)
          );
        }),
        (ep.prototype._toJSONObject = function () {
      ...
      var ec = { US: "US", EU: "EU" },
        ...
        ef = {
          ...
          library: { name: "amplitude-js", version: eh },
          logLevel: "WARN",
            ...
            _(e, [
              {
                ...
                value: function (e, t, n) {
                  var i = "https";
                  t || "https:" === T.location.protocol || (i = "http");
                  var r = i + "://" + ed(e),
                    o = this;
                  if (T.XDomainRequest) {
                    var s = new T.XDomainRequest();
                    s.open("GET", r, !0),
                      (s.onload = function () {
        ...
        eg = function (e) {
          (0, o.kP)() ||
            ...
            (this.options = f(
              ...
              {},
              {
                headers: f({}, ef.headers),
                ingestionMetadata: f({}, ef.ingestionMetadata),
                library: f({}, ef.library),
                plan: f({}, ef.plan),
                trackingOptions: f({}, ef.trackingOptions),
              }
            )),
            (this._q = []),
            (this._sending = !1),
      ...
      (eg.prototype.Identify = ea),
        (eg.prototype.Revenue = ep),
        (eg.prototype.init = function (e, t, n, i) {
          var r = this;
          if ("string" !== C(e) || G.isEmptyString(e)) {
            G.log.error(
          ...
          try {
            (this._connector = l.V.getInstance(this._instanceName)),
              e_(this.options, n),
              ((0, o.kP)() || G.isWebWorkerEnvironment()) &&
                void 0 !== T.Prototype &&
              ...
              (this.cookieStorage = new en().getStorage(
            ...
            (this.options.domain = this.cookieStorage.options().domain),
              "string" === C(this.options.logLevel) &&
            ...
            (this._apiPropertiesTrackingOptions =
              ...
              this.options.cookieForceUpgrade &&
                s &&
                (a || eE(this), this.cookieStorage.remove(this._oldCookiename)),
              em(this),
              ...
              (function () {
                n &&
                  ...
                  (r.options.userId =
                    ("string" === C(t) && !G.isEmptyString(t) && t) ||
                    ("number" === C(t) && t.toString()) ||
                    r.options.userId ||
                    null);
                var e = new Date().getTime(),
                  i =
                    !r._sessionId ||
                    !r._lastEventTime ||
                    e - r._lastEventTime > r.options.sessionTimeout ||
                    r.options.sessionId;
                i &&
                  (r.options.unsetParamsReferrerOnNewSession &&
                    r._unsetUTMParams(),
                  (r._newSession = !0),
                  (r._sessionId = r.options.sessionId || e),
                  ...
                  r.options.saveEvents &&
                    (ey(r._unsentEvents), ey(r._unsentIdentifys)),
                  (r._lastEventTime = e),
                  eS(r),
                  (r._pendingReadStorage = !1),
                  r._sendEventsIfReady();
                for (var o = 0; o < r._onInitCallbacks.length; o++)
                  r._onInitCallbacks[o](r);
                (r._onInitCallbacks = []),
                  (r._isInitialized = !0),
                  i && r._runNewSessionStartCallbacks();
              })(),
            ...
            if (
              ...
              var c = function () {
                ...
                r.setTransport(N.TRANSPORT_BEACON), p(), r.setTransport(e);
              };
              T.addEventListener(
                "pagehide",
                function () {
            ...
            G.log.error(e), n && "function" === C(n.onError) && n.onError(e);
          }
        }),
        (eg.prototype._runNewSessionStartCallbacks = function () {
          for (var e = 0; e < this._onNewSessionStartCallbacks.length; e++)
            this._onNewSessionStartCallbacks[e](this);
        }),
        (eg.prototype.deleteLowerLevelDomainCookies = function () {
          var e = G.getHost(),
            t =
          ...
          if (
            ...
            for (
              var n = e.split("."), i = t.split("."), r = n.length;
              r > i.length;
              --r
            ) {
              var o = n.slice(n.length - r).join(".");
              F.set(this._cookieName, null, { domain: "." + o });
            }
            F.set(this._cookieName, null, {});
          }
        }),
        (eg.prototype._getInitialDeviceId = function (e, t) {
          if (e) return e;
          if (this.options.deviceIdFromUrlParam) {
            var n = this._getDeviceIdFromUrlParam(this._getUrlParams());
            if (n) return n;
          }
          return this.options.deviceId ? this.options.deviceId : t || X();
        });
      var ey = function (e) {
        for (var t = 0; t < e.length; t++) {
          var n = e[t].event.user_properties,
            ...
            r = e[t].event.groups;
          (e[t].event.user_properties = G.validateProperties(n)),
            (e[t].event.event_properties = G.validateProperties(i)),
            (e[t].event.groups = G.validateGroups(r));
        }
      };
      eg.prototype._trackParamsAndReferrer = function () {
        if (
          ...
          var e,
            ...
            i,
            r = f(f(f(f({}, e), t), n), i);
          Object.keys(r).length > 0 && this.logEvent(N.ATTRIBUTION_EVENT, r);
        }
      };
              ...
              : Object.prototype.hasOwnProperty.call(n, o) &&
                (function (i) {
                  if (Object.prototype.hasOwnProperty.call(t, i)) {
                    var o = n[i],
                      s = C(t[i]);
                    if ("transport" !== i || G.validateTransport(o)) {
                      if ("sessionId" === i && null !== o) {
                        t[i] = G.validateSessionId(o) ? o : null;
                        return;
                      }
                      G.validateInput(o, i + " option", s) &&
                        ("boolean" === s
                          ? (t[i] = !!o)
                          : ("string" === s && !G.isEmptyString(o)) ||
                            ("number" === s &&
                              (o > 0 || (0 === o && r.has(i)))) ||
                            "function" === s
                          ? (t[i] = o)
      ...
      (eg.prototype.runQueuedFunctions = function () {
        var e = this._q;
        this._q = [];
        for (var t = 0; t < e.length; t++) {
          var n = this[e[t][0]];
        ...
        (eg.prototype._apiKeySet = function (e) {
          return (
        ...
        (eg.prototype.isNewSession = function () {
          return this._newSession;
        }),
        (eg.prototype.onInit = function (e) {
          this._isInitialized ? e(this) : this._onInitCallbacks.push(e);
        }),
        (eg.prototype.onNewSessionStart = function (e) {
          this._onNewSessionStartCallbacks.push(e);
        }),
        (eg.prototype.getSessionId = function () {
          return this._sessionId;
        }),
        (eg.prototype.nextEventId = function () {
          return this._eventId++, this._eventId;
        }),
        (eg.prototype.nextIdentifyId = function () {
          return this._identifyId++, this._identifyId;
        }),
        (eg.prototype.nextSequenceNumber = function () {
          return this._sequenceNumber++, this._sequenceNumber;
        }),
        (eg.prototype._unsentCount = function () {
          return this._unsentEvents.length + this._unsentIdentifys.length;
        }),
        (eg.prototype._sendEventsIfReady = function () {
          return (
            0 !== this._unsentCount() &&
        ...
        (eg.prototype.clearStorage = function () {
          return this._metadataStorage.clear();
        }),
        (eg.prototype._getFromStorage = function (e, t) {
          return e.getItem(t + this._storageSuffix);
        }),
        (eg.prototype._setInStorage = function (e, t, n) {
      ...
      (eg.prototype._initUtmData = function (e, t) {
        e = e || this._getUrlParams();
        var n = eo((t = t || this.cookieStorage.get("__utmz")), e);
        return eN(this, n), n;
      }),
        (eg.prototype._unsetUTMParams = function () {
          var e = new ea();
          e.unset(N.REFERRER),
      ...
      (eg.prototype._getReferrer = function () {
        return (
          this._getReferrerFromUrlParam(this._getUrlParams()) ||
          ("undefined" != typeof document ? document.referrer : "")
        );
      }),
        (eg.prototype._getUrlParams = function () {
          return T.location.search;
        }),
        (eg.prototype._saveGclid = function (e) {
        ...
        (eg.prototype._saveFbclid = function (e) {
          var t = G.getQueryParam("fbclid", e);
          if (!G.isEmptyString(t)) {
            var n = { fbclid: t };
            return eN(this, n), n;
          }
        }),
        (eg.prototype._getDeviceIdFromUrlParam = function (e) {
          return G.getQueryParam(N.AMP_DEVICE_ID_PARAM, e);
        }),
        (eg.prototype._getReferrerFromUrlParam = function (e) {
          return G.getQueryParam(N.AMP_REFERRER_PARAM, e);
        }),
        (eg.prototype._getReferringDomain = function (e) {
          if (G.isEmptyString(e)) return null;
          var t = e.split("/");
          return t.length >= 3 ? t[2] : null;
        }),
        (eg.prototype._saveReferrer = function (e) {
        ...
        (eg.prototype.saveEvents = function () {
          try {
        ...
        (eg.prototype.setDomain = function (e) {
        ...
        (eg.prototype.setUserId = function (e) {
          var t =
            arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
          if (G.validateInput(t, "startNewSession", "boolean")) {
            if (this._shouldDeferCall())
              return this._q.push(
        ...
        (eg.prototype.setGroup = function (e, t) {
          if (this._shouldDeferCall())
            return this._q.push(
        ...
        (eg.prototype.setOptOut = function (e) {
          if (this._shouldDeferCall())
            return this._q.push(
          ...
          if (G.validateInput(e, "enable", "boolean"))
            try {
              (this.options.optOut = e), eS(this);
            } catch (e) {
              G.log.error(e);
            }
        }),
        (eg.prototype.setSessionId = function (e) {
          if (G.validateInput(e, "sessionId", "number"))
            try {
              (this._sessionId = e), eS(this);
            } catch (e) {
              G.log.error(e);
            }
        }),
        (eg.prototype.resetSessionId = function () {
          this.setSessionId(new Date().getTime());
        }),
        (eg.prototype.regenerateDeviceId = function () {
          if (this._shouldDeferCall())
            return this._q.push(
        ...
        (eg.prototype.setDeviceId = function (e) {
          if (this._shouldDeferCall())
            return this._q.push(
              ["setDeviceId"].concat(Array.prototype.slice.call(arguments, 0))
            );
          if (G.validateDeviceId(e))
            try {
              !G.isEmptyString(e) &&
        ...
        (eg.prototype.setTransport = function (e) {
          if (this._shouldDeferCall())
            return this._q.push(
              ["setTransport"].concat(Array.prototype.slice.call(arguments, 0))
            );
          G.validateTransport(e) && (this.options.transport = e);
        }),
        (eg.prototype.setUserProperties = function (e) {
          if (this._shouldDeferCall())
            return this._q.push(
        ...
        (eg.prototype.clearUserProperties = function () {
          if (this._shouldDeferCall())
            return this._q.push(
      ...
      (eg.prototype.identify = function (e, t, n, i) {
        if (this._shouldDeferCall())
          return this._q.push(
            ["identify"].concat(Array.prototype.slice.call(arguments, 0))
          );
        if (!this._apiKeySet("identify()")) {
          ek(t, n, 0, "No request sent", { reason: "API key is not set" });
          return;
        }
        if (
          ("object" === C(e) &&
        ...
        (eg.prototype.groupIdentify = function (e, t, n, i, r, o) {
          if (this._shouldDeferCall())
            return this._q.push(
              ["groupIdentify"].concat(Array.prototype.slice.call(arguments, 0))
            );
          if (!this._apiKeySet("groupIdentify()")) {
            ek(i, r, 0, "No request sent", { reason: "API key is not set" });
            return;
          }
          if (
            !G.validateInput(e, "group_type", "string") ||
            G.isEmptyString(e)
          ) {
            ek(i, r, 0, "No request sent", { reason: "Invalid group type" });
            return;
          }
          if (null == t) {
            ek(i, r, 0, "No request sent", { reason: "Invalid group name" });
            return;
          }
          if (
            ("object" === C(n) &&
        ...
        (eg.prototype.setVersionName = function (e) {
          if (this._shouldDeferCall())
            return this._q.push(
        ...
        (eg.prototype._logEvent = function (e, t, n, i, r, o, s, a, u, p) {
          if ((em(this), !e)) {
            ek(a, u, 0, "No request sent", { reason: "Missing eventType" });
            return;
          }
          if (this.options.optOut) {
            ek(a, u, 0, "No request sent", { reason: "optOut is set to true" });
            return;
          }
          try {
            c =
            ...
            var c,
              ...
              d = "number" === C(s) ? s : new Date().getTime();
            p
              ? (this._sessionId = -1)
              : (this._sessionId &&
                  this._lastEventTime &&
            ...
            var m = {
              ...
              platform: eR(this, "platform") ? this.options.platform : null,
              os_name: (eR(this, "os_name") && h) || null,
              os_version: (eR(this, "os_version") && v) || null,
              device_model: (eR(this, "device_model") && g) || null,
              device_manufacturer:
                (eR(this, "device_manufacturer") && y) || null,
              language: eR(this, "language") ? this.options.language : null,
              api_properties: n,
              event_properties: G.truncate(G.validateProperties(t)),
              user_properties: G.truncate(G.validateProperties(i)),
              uuid: (function e(t) {
                return t
              ...
              sequence_number: l,
              groups: G.truncate(G.validateGroups(r)),
              group_properties: G.truncate(G.validateProperties(o)),
            ...
            return (
              ...
              e === N.IDENTIFY_EVENT &&
                ...
                this._connector.identityStore
                  .editIdentity()
                  .updateUserProperties(G.truncate(G.validateProperties(i)))
                  .commit(),
              c
            );
          } catch (e) {
      ...
      (eg.prototype._limitEventsQueued = function (e) {
        ...
        (eg.prototype.logEvent = function (e, t, n, i) {
          ...
          return this._shouldDeferCall()
            ...
            : this.logEventWithTimestamp(e, t, null, n, i, r);
        }),
        (eg.prototype.logEventWithTimestamp = function (e, t, n, i, r) {
          var o =
            ...
            ? G.validateInput(e, "eventType", "string")
              ? G.isEmptyString(e)
                ? (ek(i, r, 0, "No request sent", {
                  ...
                  -1)
                : (G.validateInput(o, "outOfSession", "boolean") ||
                    ek(i, r, 0, "No request sent", {
                      reason: "Invalid outOfSession value",
                    }),
                  this._logEvent(e, t, null, null, null, null, n, i, r, o))
              : (ek(i, r, 0, "No request sent", {
                  reason: "Invalid type for eventType",
                }),
                -1)
            : (ek(i, r, 0, "No request sent", { reason: "API key not set" }),
              -1);
        }),
        (eg.prototype.logEventWithGroups = function (e, t, n, i, r) {
          var o =
            arguments.length > 5 && void 0 !== arguments[5] && arguments[5];
          return this._shouldDeferCall()
            ? this._q.push(
            ...
            ? G.validateInput(e, "eventType", "string")
              ? (G.validateInput(o, "outOfSession", "boolean") ||
                ...
                this._logEvent(e, t, null, null, n, null, null, i, r, o))
              : (ek(event.callback, event.errorCallback, 0, "No request sent", {
                  reason: "Invalid type for eventType",
                }),
                -1)
            : (ek(event.callback, event.errorCallback, 0, "No request sent", {
      ...
      var eC = function (e) {
        ...
        ek = function (e, t, n, i, r) {
          "function" === C(e) && e(n, i, r), "function" === C(t) && t(n, i, r);
        };
      (eg.prototype.logRevenueV2 = function (e) {
        if (this._shouldDeferCall())
          return this._q.push(
        ...
        (eg.prototype.logRevenue = function (e, t, n) {
          return this._shouldDeferCall()
            ? this._q.push(
        ...
        (eg.prototype._logErrorsOnEvents = function (e, t, n, i) {
          for (
            var r = ["_unsentEvents", "_unsentIdentifys"], o = 0;
            o < r.length;
            o++
          )
            for (
              var s = r[o], a = "_unsentEvents" === s ? e : t, u = 0;
              u < this[s].length;
              u++
            ) {
              var p = this[s][u];
        ...
        (eg.prototype.removeEvents = function (e, t, n, i) {
          eP(this, "_unsentEvents", e, n, i),
            eP(this, "_unsentIdentifys", t, n, i);
        });
      var eP = function (e, t, n, i, r) {
        if (!(n < 0)) {
      ...
      (eg.prototype.sendEvents = function () {
        ...
        if (0 !== this._unsentCount()) {
          ...
          var e =
            ...
            u = {
              ...
              v: N.API_VERSION,
              upload_time: s,
              checksum: a()(N.API_VERSION + this.options.apiKey + o + s),
            };
          if (
            this.options.transport === N.TRANSPORT_BEACON &&
            "undefined" != typeof navigator
            ...
            navigator.sendBeacon(e, new URLSearchParams(u))
              ? (this.removeEvents(i, r, 200, "success"),
                this.options.saveEvents && this.saveEvents())
              : this._logErrorsOnEvents(i, r, 0, "");
            return;
          }
          var p = this;
          try {
            new eu(e, u, this.options.headers).send(function (e, n) {
              p._sending = !1;
              try {
                200 === e
                  ? (p.removeEvents(i, r, e, n),
                    p.options.saveEvents && p.saveEvents(),
                    p._sendEventsIfReady())
                  : (p._logErrorsOnEvents(i, r, e, n),
                    413 === e &&
            ...
            G.log.error(c),
              p._logErrorsOnEvents(i, r, 0, c),
              p.removeEvents(i, r, 0, c, { reason: e.message });
          }
        }
      }),
        (eg.prototype._mergeEventsAndIdentifys = function (e) {
            ...
            a
              ...
              : "sequence_number" in this._unsentEvents[n].event &&
                !(
                  ...
                  this._unsentIdentifys[r].event.sequence_number
                )
              ? (o = (s = this._unsentIdentifys[r++]).event.event_id)
              : (i = (s = this._unsentEvents[n++]).event.event_id),
              t.push(s);
          }
          return { eventsToSend: t, maxEventId: i, maxIdentifyId: o };
        }),
        (eg.prototype.setGlobalUserProperties = function (e) {
          this.setUserProperties(e);
        }),
        (eg.prototype.__VERSION__ = function () {
          return this.options.library.version;
        }),
        (eg.prototype.setLibrary = function (e, t) {
          null != e && (this.options.library.name = e),
            null != t && (this.options.library.version = t);
        }),
        (eg.prototype._shouldDeferCall = function () {
          return this._pendingReadStorage || this._initializationDeferred;
        }),
        (eg.prototype._deferInitialization = function () {
          (this._initializationDeferred = !0),
            this._q.push(
              ["init"].concat(Array.prototype.slice.call(arguments, 0))
            );
        }),
        (eg.prototype.enableTracking = function () {
          (this._initializationDeferred = !1),
            eS(this),
            this.runQueuedFunctions();
        }),
        (eg.prototype._refreshDynamicConfig = function () {
          this.options.useDynamicConfig &&
            ev.refresh(
              this.options.serverZone,
              this.options.forceHttps,
              function () {
                this.options.apiEndpoint = ev.ingestionEndpoint;
              }.bind(this)
            );
        }),
        (eg.prototype.getDeviceId = function () {
          return this.options.deviceId;
        }),
        (eg.prototype.getUserId = function () {
          return this.options.userId;
        }),
        (eg.prototype.setMinTimeBetweenSessionsMillis = function (e) {
          if (G.validateInput(e, "timeInMillis", "number")) {
            if (this._shouldDeferCall())
              return this._q.push(
        ...
        (eg.prototype.setEventUploadThreshold = function (e) {
          if (G.validateInput(e, "eventUploadThreshold", "number")) {
            if (this._shouldDeferCall())
              return this._q.push(
        ...
        (eg.prototype.setUseDynamicConfig = function (e) {
          if (G.validateInput(e, "useDynamicConfig", "boolean")) {
            if (this._shouldDeferCall())
              return this._q.push(
        ...
        (eg.prototype.setServerZone = function (e) {
          var t =
            !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
          if (
            (e === ec.EU || e === ec.US) &&
            G.validateInput(t, "serverZoneBasedApi", "boolean")
          ) {
            if (this._shouldDeferCall())
              return this._q.push(
            ...
            try {
              (this.options.serverZone = e),
                ...
                t && (this.options.apiEndpoint = el(this.options.serverZone));
            } catch (e) {
              G.log.error(e);
            }
          }
        }),
        (eg.prototype.setServerUrl = function (e) {
          if (G.validateInput(e, "serverUrl", "string")) {
            if (this._shouldDeferCall())
              return this._q.push(
                ["setServerUrl"].concat(
                  Array.prototype.slice.call(arguments, 0)
      ...
      var eD = function () {
        (this.options = f({}, ef)), (this._q = []), (this._instances = {});
      };
      (eD.prototype.Identify = ea),
        (eD.prototype.Revenue = ep),
        (eD.prototype.getInstance = function (e) {
          e = G.isEmptyString(e) ? N.DEFAULT_INSTANCE : e.toLowerCase();
          var t = this._instances[e];
          return void 0 === t && ((t = new eg(e)), (this._instances[e] = t)), t;
        }),
        (eD.prototype.init = function (e, t, n, i) {
        ...
        (eD.prototype.isNewSession = function () {
          return this.getInstance().isNewSession();
        }),
        (eD.prototype.getSessionId = function () {
          return this.getInstance().getSessionId();
        }),
        (eD.prototype.nextEventId = function () {
          return this.getInstance().nextEventId();
        }),
        (eD.prototype.nextIdentifyId = function () {
          return this.getInstance().nextIdentifyId();
        }),
        (eD.prototype.nextSequenceNumber = function () {
          return this.getInstance().nextSequenceNumber();
        }),
        (eD.prototype.saveEvents = function () {
          this.getInstance().saveEvents();
        }),
        (eD.prototype.setDomain = function (e) {
          this.getInstance().setDomain(e);
        }),
        (eD.prototype.setUserId = function (e) {
          this.getInstance().setUserId(e);
        }),
        (eD.prototype.setGroup = function (e, t) {
          this.getInstance().setGroup(e, t);
        }),
        (eD.prototype.setOptOut = function (e) {
          this.getInstance().setOptOut(e);
        }),
        (eD.prototype.regenerateDeviceId = function () {
          this.getInstance().regenerateDeviceId();
        }),
        (eD.prototype.setDeviceId = function (e) {
          this.getInstance().setDeviceId(e);
        }),
        (eD.prototype.setUserProperties = function (e) {
          this.getInstance().setUserProperties(e);
        }),
        (eD.prototype.clearUserProperties = function () {
          this.getInstance().clearUserProperties();
        }),
        (eD.prototype.identify = function (e, t) {
          this.getInstance().identify(e, t);
        }),
        (eD.prototype.setVersionName = function (e) {
          this.getInstance().setVersionName(e);
        }),
        (eD.prototype.logEvent = function (e, t, n) {
          return this.getInstance().logEvent(e, t, n);
        }),
        (eD.prototype.logEventWithGroups = function (e, t, n, i) {
          return this.getInstance().logEventWithGroups(e, t, n, i);
        }),
        (eD.prototype.logRevenueV2 = function (e) {
          return this.getInstance().logRevenueV2(e);
        }),
        (eD.prototype.logRevenue = function (e, t, n) {
          return this.getInstance().logRevenue(e, t, n);
        }),
        (eD.prototype.removeEvents = function (e, t) {
          this.getInstance().removeEvents(e, t);
        }),
        (eD.prototype.sendEvents = function (e) {
          this.getInstance().sendEvents(e);
        }),
        (eD.prototype.setGlobalUserProperties = function (e) {
          this.getInstance().setUserProperties(e);
        }),
        (eD.prototype.__VERSION__ = eh);
      var eU = (void 0 !== T && T.amplitude) || {},
        ew = new eD();
      for (var eM in ((ew._q = eU._q || []), eU._iq))
        Object.prototype.hasOwnProperty.call(eU._iq, eM) &&
          (ew.getInstance(eM)._q = eU._iq[eM]._q || []);
    },
  },
]);
